...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/NebulaSEN/NebulaSEN.nif",
		"FilenameMed": "data/Models/Ships/NebulaSEN/NebulaSENMed.nif",
		"FilenameLow": "data/Models/Ships/NebulaSEN/NebulaSENLow.nif",
		"Name": "Phoenix",
