...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Aegean/Aegean.nif",
		"FilenameMed": "data/Models/Ships/Aegean/Aegean.nif",
		"FilenameLow": "data/Models/Ships/Aegean/Aegean.nif",
		"Name": "USS Aegean",
		"HardpointFile": "Aegean",
		"Species": Multiplayer.SpeciesToShip.AEGEAN
		 }
	return kShipStats
