...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/NebulaWEP/NebulaWEP.nif",
		"FilenameMed": "data/Models/Ships/NebulaWEP/NebulaWEPMED.nif",
		"FilenameLow": "data/Models/Ships/NebulaWEP/NebulaWEPLOW.nif",
		"Name": "Nebula",
