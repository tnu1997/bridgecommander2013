...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Breen/Breen.nif",
		"FilenameMed": "data/Models/Ships/Breen/Breen.nif",
		"FilenameLow": "data/Models/Ships/Breen/Breen.nif",
		"Name": "Breen",
		"HardpointFile": "Breen",
		"Species": Multiplayer.SpeciesToShip.BREEN,
		"SpecularCoef": 0.5,
		 }
	return kShipStats
