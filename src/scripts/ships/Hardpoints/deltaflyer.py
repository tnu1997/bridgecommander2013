# C:\Users\Owner\Documents\KMFinalHP_Changes_(2)\Deltaflyer.py
...
Phaser.SetPrimary(1)
Phaser.SetPosition(0.019286, 0.080268, -0.015617)
...
PortImpulse.SetPosition(-0.049243, 0.022731, -0.019107)
...
StarImpulse.SetPosition(0.048589, 0.023831, -0.018834)
...
Phaser2.SetPosition(-0.020619, 0.077518, -0.016418)
...
Phaser2.SetMainRadius(0.020000)
...
Phaser3.SetPosition(0.050600, 0.004652, -0.016494)
...
Phaser4.SetPosition(-0.049752, 0.004025, -0.016013)
...
AftPhaser.SetPosition(-0.015535, -0.093765, 0.003147)
...
AftPhaser.SetWidth(0.001000)
AftPhaser.SetLength(0.001000)
...
AftPhaser2.SetTargetable(0)
AftPhaser2.SetPrimary(1)
AftPhaser2.SetPosition(0.014764, -0.094742, 0.003608)
...
VentralPhaser.SetTargetable(0)
VentralPhaser.SetPrimary(1)
VentralPhaser.SetPosition(-0.000216, 0.058768, -0.023457)
VentralPhaser.SetPosition2D(65.000000, 26.000000)
...
VentralPhaser.SetIconPositionX(62.000000)
VentralPhaser.SetIconPositionY(25.000000)
...
VentralPhaser.SetMainRadius(0.020000)
...
VentralPhaser2.SetPosition(0.043506, 0.004011, -0.020840)
VentralPhaser2.SetPosition2D(65.000000, 26.000000)
...
VentralPhaser2.SetIndicatorIconPositionY(21.000000)
...
VentralPhaser2.SetArcWidthAngles(-0.959931, 0.872665)
...
VentralPhaser2.SetMainRadius(0.020000)
...
VentralPhaser3.SetPosition(-0.047912, 0.010247, -0.022540)
VentralPhaser3.SetPosition2D(65.000000, 26.000000)
...
VentralPhaser3.SetIconPositionY(25.000000)
...
VentralPhaser3.SetIndicatorIconPositionX(56.000000)
VentralPhaser3.SetIndicatorIconPositionY(21.000000)
...
VentralPhaser3.SetArcWidthAngles(-0.959931, 0.872665)
...
VentralPhaser3.SetMainRadius(0.020000)
