# C:\Documents and Settings\Nebula\My Documents\My Received Files\FinalHP_Changes(1)\Fixed HP files\Steamrunner.py
...
WarpCore.SetPosition(-0.003642, -2.158200, -0.105085)
...
WarpEngines.SetPosition(0.102830, -0.293800, -0.440700)
...
PortWarp.SetPosition(-1.192640, -1.669710, 0.228191)
...
StarWarp.SetPosition(1.220650, -1.726400, 0.218302)
...
Engineering.SetPosition(-0.007097, -2.289160, -0.122731)
...
AftTorp1.SetIconPositionX(76.000000)
AftTorp1.SetIconPositionY(120.000000)
...
VentralPhaser2.SetLength(0.030000)
...
Tractors.SetPosition(0.102830, 0.073450, -0.631670)
...
ForwardTractor.SetPosition(-0.003102, 1.565720, -0.220069)
...
ShuttleBay.SetPosition(0.000000, -0.600000, 0.200000)
...
ShuttleBayOEPPosition.SetXYZ(0.000000, -0.600000, 0.200000)
