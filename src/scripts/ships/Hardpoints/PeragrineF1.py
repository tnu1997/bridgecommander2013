# C:\Documents and Settings\Nebula\My Documents\My Received Files\FinalHP_Changes(1)\Fixed HP files\PeragrineF1.py
...
PortPhaser.SetMainRadius(0.050000)
...
StarPhaser.SetMainRadius(0.050000)
