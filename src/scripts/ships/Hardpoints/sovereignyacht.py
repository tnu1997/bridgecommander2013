# C:\Documents and Settings\Nebula\My Documents\My Received Files\FinalHP_Changes(1)\Fixed HP files\sovereignyacht.py
...
TorpedoSystem.SetNormalPowerPerSecond(10.000000)
...
StarWarp.SetPosition(0.094956, -0.103817, 0.004594)
...
PortWarp.SetPosition(-0.096370, -0.100854, 0.004534)
...
ForPhaser1.SetMainRadius(0.020000)
...
ForPhaser2.SetMainRadius(0.020000)
...
AfterPhaser1.SetMaxDamage(250.000000)
...
AfterPhaser2.SetMaxDamage(300.000000)
