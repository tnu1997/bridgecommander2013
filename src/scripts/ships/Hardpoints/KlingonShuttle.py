# C:\Users\Owner\Documents\FinalHP_Changes_Klings\KlingonShuttle.py
...
FwdTorpedo.SetPosition(0.000000, 0.031000, 0.020100)
...
PortCannon.SetPosition(0.000000, 0.071000, 0.000000)
...
PortCannon.SetRechargeRate(0.200000)
...
PortCannon.SetModuleName("Tactical.Projectiles.ShuttlePulseDisruptor")
...
StarCannon.SetPosition(0.004000, 0.074000, 0.000000)
...
StarCannon.SetRechargeRate(0.200000)
...
StarCannon.SetModuleName("Tactical.Projectiles.ShuttlePulseDisruptor")
...
CloakingDevice.SetNormalPowerPerSecond(97.000000)
