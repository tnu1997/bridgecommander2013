...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Ambassador/Exeter.nif",
		"FilenameMed": "data/Models/Ships/Ambassador/Exeter.nif",
		"FilenameLow": "data/Models/Ships/Ambassador/Exeter.nif",
		"Name": "USS Exeter",
