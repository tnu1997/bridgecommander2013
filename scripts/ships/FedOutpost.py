...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/FedBases/FedOutpost.nif",
		"FilenameMed": "data/Models/Bases/FedBases/FedOutpost.nif",
		"FilenameLow": "data/Models/Bases/FedBases/FedOutpost.nif",
		"Name": "FedOutpost",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.SetTextureSharePath("data/Models/Bases/FedOutpost")
