...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Nebula/NebulaVar1_B.nif",
		"FilenameMed": "data/Models/Ships/Nebula/NebulaVar1_B.nif",
		"FilenameLow": "data/Models/Ships/Nebula/NebulaVar1_B.nif",
		"Name": "USS Bonchune",
