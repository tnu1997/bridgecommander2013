...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/CardShips/Keldon.nif",
		"FilenameMed": "data/Models/Ships/CardShips/Keldon.nif",
		"FilenameLow": "data/Models/Ships/CardShips/Keldon.nif",
		"Name": "Keldon",
