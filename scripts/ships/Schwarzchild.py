...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Sovereign/WarIntimidator.nif",
		"FilenameMed": "data/Models/Ships/Sovereign/WarIntimidator.nif",
		"FilenameLow": "data/Models/Ships/Sovereign/WarIntimidator.nif",
		"Name": "USS Schwarzchild",
		"HardpointFile": "WarIntimidator",
