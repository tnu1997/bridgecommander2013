...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/CardBases/CardOutpost.nif",
		"FilenameMed": "data/Models/Bases/CardBases/CardOutpost.nif",
		"FilenameLow": "data/Models/Bases/CardBases/CardOutpost.nif",
		"Name": "CardFacility",
