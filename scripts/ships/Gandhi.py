...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Ambassador/Gandhi.nif",
		"FilenameMed": "data/Models/Ships/Ambassador/Gandhi.nif",
		"FilenameLow": "data/Models/Ships/Ambassador/Gandhi.nif",
		"Name": "USS Gandhi",
