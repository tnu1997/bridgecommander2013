...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Nebula/NebulaVar1.nif",
		"FilenameMed": "data/Models/Ships/Nebula/NebulaVar1.nif",
		"FilenameLow": "data/Models/Ships/Nebula/NebulaVar1.nif",
		"Name": "USS Monitor",
