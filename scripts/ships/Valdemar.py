...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Ambassador/Valdemar.nif",
		"FilenameMed": "data/Models/Ships/Ambassador/Valdemar.nif",
		"FilenameLow": "data/Models/Ships/Ambassador/Valdemar.nif",
		"Name": "USS Valdemar",
