...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Galaxy/WarGalaxy.nif",
		"FilenameMed": "data/Models/Ships/Galaxy/WarGalaxy.nif",
		"FilenameLow": "data/Models/Ships/Galaxy/WarGalaxy.nif",
		"Name": "USS San Francisco 2",
		"HardpointFile": "WarGalaxy2",
