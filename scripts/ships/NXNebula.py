...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Nebula/NXNebula.nif",
		"FilenameMed": "data/Models/Ships/Nebula/NXNebula.nif",
		"FilenameLow": "data/Models/Ships/Nebula/NXNebula.nif",
		"Name": "USS Nebula(NX)",
		"HardpointFile": "NXNebula",
