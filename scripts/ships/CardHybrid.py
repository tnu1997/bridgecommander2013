...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/CardShips/Hybrid.nif",
		"FilenameMed": "data/Models/Ships/CardShips/Hybrid.nif",
		"FilenameLow": "data/Models/Ships/CardShips/Hybrid.nif",
		"Name": "CardHybrid",
		"HardpointFile": "Hybrid",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.SetTextureSharePath("data/Models/Ships/CardHybrid")
