...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Prometheus/Prometheus.nif",
		"FilenameMed": "data/Models/Ships/Prometheus/Prometheus.nif",
		"FilenameLow": "data/Models/Ships/Prometheus/Prometheus.nif",
		"Name": "USS Prometheus",
