...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Ambassador/Zhukov.nif",
		"FilenameMed": "data/Models/Ships/Ambassador/Zhukov.nif",
		"FilenameLow": "data/Models/Ships/Ambassador/Zhukov.nif",
		"Name": "USS Zhukov",
