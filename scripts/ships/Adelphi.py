...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Ambassador/Adelphi.nif",
		"FilenameMed": "data/Models/Ships/Ambassador/Adelphi.nif",
		"FilenameLow": "data/Models/Ships/Ambassador/Adelphi.nif",
		"Name": "USS Adelphi",
