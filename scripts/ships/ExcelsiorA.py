...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Galaxy/GalaxyRefitI.nif",
		"FilenameMed": "data/Models/Ships/Galaxy/GalaxyRefitI.nif",
		"FilenameLow": "data/Models/Ships/Galaxy/GalaxyRefitI.nif",
		"Name": "USS Excelsior-A",
		"HardpointFile": "GalaxyRefitI",
