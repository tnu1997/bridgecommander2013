...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Akira/NXAkira.nif",
		"FilenameMed": "data/Models/Ships/Akira/NXAkira.nif",
		"FilenameLow": "data/Models/Ships/Akira/NXAkira.nif",
		"Name": "USS Akira(NX)",
		"HardpointFile": "NXAkira",
