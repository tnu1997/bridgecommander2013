...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Galaxy/GalaxyRefitII.nif",
		"FilenameMed": "data/Models/Ships/Galaxy/GalaxyRefitII.nif",
		"FilenameLow": "data/Models/Ships/Galaxy/GalaxyRefitII.nif",
		"Name": "Galaxy Refit II",
