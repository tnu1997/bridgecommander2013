...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Galaxy/NXGalaxy.nif",
		"FilenameMed": "data/Models/Ships/Galaxy/NXGalaxy.nif",
		"FilenameLow": "data/Models/Ships/Galaxy/NXGalaxy.nif",
		"Name": "USS Galaxy(NX)",
		"HardpointFile": "NXGalaxy",
