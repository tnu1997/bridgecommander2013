...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/CardBases/CardStarbase.nif",
		"FilenameMed": "data/Models/Bases/CardBases/CardStarbase.nif",
		"FilenameLow": "data/Models/Bases/CardBases/CardStarbase.nif",
		"Name": "CardStarbase",
