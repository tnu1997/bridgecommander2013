...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Galaxy/Europa.nif",
		"FilenameMed": "data/Models/Ships/Galaxy/Europa.nif",
		"FilenameLow": "data/Models/Ships/Galaxy/Europa.nif",
		"Name": "USS Vladivostok",
		"HardpointFile": "Europa",
