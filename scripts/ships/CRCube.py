#	This ship script is a modified script from the C2Extreme Voyager Cube
...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/BorgShips/BorgCube.nif",
		"FilenameMed": "data/Models/Ships/BorgShips/BorgCube.nif",
		"FilenameLow": "data/Models/Ships/BorgShips/BorgCube.nif",
		"Name": "CRCube",
		"HardpointFile": "CRCube",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 10, 500.0, 100.0, 100.0, 400, 900, "_glow", None, "_spec")
		pLODModel.AddLOD(pStats["FilenameMed"],  10, 250.0, 200.0, 200.0, 400, 900, "_glow", None, "_spec")
		pLODModel.AddLOD(pStats["FilenameLow"],  10, 125.0, 400.0, 200.0, 400, 900, "_glow", None, None)
