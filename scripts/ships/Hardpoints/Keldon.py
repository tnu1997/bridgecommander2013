...
ShieldGenerator.SetMaxShields(ShieldGenerator.TOP_SHIELDS, 4307.692308)
ShieldGenerator.SetMaxShields(ShieldGenerator.BOTTOM_SHIELDS, 4307.692308)
...
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.TOP_SHIELDS, 7.179488)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.BOTTOM_SHIELDS, 7.179488)
...
WarpEngine.SetMaxCondition(6000.000000)
...
RepairSubsystem.SetMaxCondition(6000.000000)
RepairSubsystem.SetCritical(0)
RepairSubsystem.SetTargetable(0)
RepairSubsystem.SetPrimary(1)
RepairSubsystem.SetPosition(0.023350, -1.000000, -0.010000)
...
Compressors.SetMaxCondition(6000.000000)
...
VentralTractor.SetMinFiringCharge(1.000000)
...
DorsalTractor.SetMinFiringCharge(1.000000)
...
VentralBeam.SetMaxCharge(1.500000)
...
VentralBeam.SetMainRadius(0.060000)
...
DorsalBeam.SetMaxCharge(1.500000)
...
DorsalBeam.SetMainRadius(0.060000)
