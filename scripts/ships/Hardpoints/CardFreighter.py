...
ShieldGenerator.SetMaxShields(ShieldGenerator.FRONT_SHIELDS, 1076.923077)
ShieldGenerator.SetMaxShields(ShieldGenerator.REAR_SHIELDS, 1076.923077)
ShieldGenerator.SetMaxShields(ShieldGenerator.TOP_SHIELDS, 1076.923077)
ShieldGenerator.SetMaxShields(ShieldGenerator.BOTTOM_SHIELDS, 1076.923077)
ShieldGenerator.SetMaxShields(ShieldGenerator.LEFT_SHIELDS, 1076.923077)
ShieldGenerator.SetMaxShields(ShieldGenerator.RIGHT_SHIELDS, 1076.923077)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.FRONT_SHIELDS, 1.196582)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.REAR_SHIELDS, 1.196582)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.TOP_SHIELDS, 1.196582)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.BOTTOM_SHIELDS, 1.196582)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.LEFT_SHIELDS, 1.196582)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.RIGHT_SHIELDS, 1.196582)
...
TractorBeam.SetMaxDamage(10000.000000)
...
Cardfreighter.SetMass(20000.000000)
Cardfreighter.SetRotationalInertia(300000000000.000000)
