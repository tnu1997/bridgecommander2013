...
ImpulseEngines.SetMaxAccel(7.500000)
...
PowerPlant.SetMaxCondition(1000.000000)
...
ShieldGenerator.SetMaxShields(ShieldGenerator.FRONT_SHIELDS, 538.461539)
ShieldGenerator.SetMaxShields(ShieldGenerator.REAR_SHIELDS, 538.461539)
ShieldGenerator.SetMaxShields(ShieldGenerator.TOP_SHIELDS, 538.461539)
ShieldGenerator.SetMaxShields(ShieldGenerator.BOTTOM_SHIELDS, 538.461539)
ShieldGenerator.SetMaxShields(ShieldGenerator.LEFT_SHIELDS, 538.461539)
ShieldGenerator.SetMaxShields(ShieldGenerator.RIGHT_SHIELDS, 538.461539)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.FRONT_SHIELDS, 0.897436)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.REAR_SHIELDS, 0.897436)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.TOP_SHIELDS, 0.897436)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.BOTTOM_SHIELDS, 0.897436)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.LEFT_SHIELDS, 0.897436)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.RIGHT_SHIELDS, 0.897436)
...
Probe.SetMass(0.0000002223)
Probe.SetRotationalInertia(3.400000)
