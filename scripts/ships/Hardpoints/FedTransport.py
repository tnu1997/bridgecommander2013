...
ShieldGenerator.SetMaxShields(ShieldGenerator.FRONT_SHIELDS, 3230.769231)
...
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.FRONT_SHIELDS, 5.384616)
...
DorsalPhaser.SetDamageRadiusFactor(0.225000)
...
DorsalPhaser.SetFireSound("Type IX Phaser")
DorsalPhaser.SetMaxCharge(5.000000)
DorsalPhaser.SetMaxDamage(625.000000)
...
DorsalPhaser.SetRechargeRate(0.200000)
...
VentralPhaser.SetFireSound("Type IX Phaser")
VentralPhaser.SetMaxCharge(5.000000)
VentralPhaser.SetMaxDamage(625.000000)
...
VentralPhaser.SetRechargeRate(0.200000)
...
Transport.SetMass(21500.000000)
Transport.SetRotationalInertia(322500000000.000000)
...
#################################################
PortTractor = App.TractorBeamProperty_Create("Tractor P")
...
PortTractor.SetRepairComplexity(1.500000)
...
PortTractor.SetMaxDamage(20000.000000)
...
PortTractor.SetRechargeRate(1.000000)
...
#################################################
StarTractor = App.TractorBeamProperty_Create("Tractor S")
...
StarTractor.SetRepairComplexity(1.500000)
...
StarTractor.SetMaxDamage(20000.000000)
...
StarTractor.SetRechargeRate(1.000000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Tractor P", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Tractor S", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
