...
FwdTorpedo.SetPosition(0.000000, 0.500000, 0.030000)
...
FwdTorpedo.SetIconPositionX(73.000000)
...
ShieldGenerator.SetMaxShields(ShieldGenerator.FRONT_SHIELDS, 5923.076924)
...
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.FRONT_SHIELDS, 9.871795)
...
SensorArray.SetPosition(0.000000, 0.100000, 0.100000)
...
ImpulseEngines.SetPosition(0.000000, -0.150000, 0.000000)
...
PortCannon.SetPosition(-0.612185, 0.324120, -0.240042)
...
PortCannon.SetIconPositionY(54.000000)
...
PortCannon.SetModuleName("Tactical.Projectiles.KPulse2")
...
StarCannon.SetPosition(4.150000, 0.580000, -1.600000)
...
StarCannon.SetIconPositionY(54.000000)
...
StarCannon.SetModuleName("Tactical.Projectiles.KPulse2")
...
WarpEngines.SetRadius(0.000200)
...
CloakingDevice.SetPosition(0.000000, 0.040000, 0.100000)
...
#################################################
ImpulseEngine = App.EngineProperty_Create("Impulse Drive")

ImpulseEngine.SetMaxCondition(2200.000000)
ImpulseEngine.SetCritical(0)
ImpulseEngine.SetTargetable(1)
ImpulseEngine.SetPrimary(1)
ImpulseEngine.SetPosition(0.000000, -0.430000, 0.100000)
...
PortWarp.SetPosition(-0.200000, -0.200000, 0.100000)
...
StarWarp.SetPosition(0.200000, -0.200000, 0.100000)
...
BirdofPrey.SetMass(3087.000000)
BirdofPrey.SetRotationalInertia(46305000000.000000)
BirdofPrey.SetShipName("Bird of Prey")
BirdofPrey.SetModelFilename("data/Models/Ships/Birdofprey.nif")
BirdofPrey.SetDamageResolution(5.000000)
