...
Hull.SetMaxCondition(48000.000000)
Hull.SetCritical(1)
...
ImpulseEngines.SetMaxCondition(48000.000000)
...
RepairSystem.SetMaxCondition(48000.000000)
...
ShieldGenerator.SetMaxShields(ShieldGenerator.FRONT_SHIELDS, 31230.769231)
ShieldGenerator.SetMaxShields(ShieldGenerator.REAR_SHIELDS, 31230.769231)
ShieldGenerator.SetMaxShields(ShieldGenerator.TOP_SHIELDS, 31230.769231)
ShieldGenerator.SetMaxShields(ShieldGenerator.BOTTOM_SHIELDS, 31230.769231)
ShieldGenerator.SetMaxShields(ShieldGenerator.LEFT_SHIELDS, 31230.769231)
ShieldGenerator.SetMaxShields(ShieldGenerator.RIGHT_SHIELDS, 31230.769231)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.FRONT_SHIELDS, 104.102565)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.REAR_SHIELDS, 104.102565)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.TOP_SHIELDS, 104.102565)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.BOTTOM_SHIELDS, 104.102565)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.LEFT_SHIELDS, 104.102565)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.RIGHT_SHIELDS, 104.102565)
App.g_kModelPropertyManager.RegisterLocalTemplate(ShieldGenerator)
#################################################
WarpEngines = App.WarpEngineProperty_Create("Warp Engines")

WarpEngines.SetMaxCondition(48000.000000)
...
SunBuster.SetMass(17666667.000000)
SunBuster.SetRotationalInertia(265000000000000.000000)
...
BeamEmitter.SetMaxCondition(48000.000000)
...
Emitter.SetGroups(0)
Emitter.SetDamageRadiusFactor(0.450000)
Emitter.SetIconNum(370)
Emitter.SetIconPositionX(75.000000)
Emitter.SetIconPositionY(90.000000)
Emitter.SetIconAboveShip(1)
Emitter.SetFireSound("Mega Phaser")
Emitter.SetMaxCharge(10.000000)
Emitter.SetMaxDamage(50000.000000)
Emitter.SetMaxDamageDistance(300.000000)
Emitter.SetMinFiringCharge(6.000000)
Emitter.SetNormalDischargeRate(1.000000)
Emitter.SetRechargeRate(0.500000)
...
Emitter.SetTextureName("data/phaser16.tga")
