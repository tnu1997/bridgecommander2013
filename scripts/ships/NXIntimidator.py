...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Sovereign/NXIntimidator.nif",
		"FilenameMed": "data/Models/Ships/Sovereign/NXIntimidator.nif",
		"FilenameLow": "data/Models/Ships/Sovereign/NXIntimidator.nif",
		"Name": "USS Intimidator(NX)",
		"HardpointFile": "NXIntimidator",
