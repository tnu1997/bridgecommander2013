...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/CardBases/CardStation.nif",
		"FilenameMed": "data/Models/Bases/CardBases/CardStation.nif",
		"FilenameLow": "data/Models/Bases/CardBases/CardStation.nif",
		"Name": "CardStation",
