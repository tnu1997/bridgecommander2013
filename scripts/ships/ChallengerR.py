...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Galaxy/GalaxyDreadnought.nif",
		"FilenameMed": "data/Models/Ships/Galaxy/GalaxyDreadnought.nif",
		"FilenameLow": "data/Models/Ships/Galaxy/GalaxyDreadnought.nif",
		"Name": "USS Challenger(Refit)",
		"HardpointFile": "GalaxyDreadnought",
