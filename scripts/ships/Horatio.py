...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Ambassador/Horatio.nif",
		"FilenameMed": "data/Models/Ships/Ambassador/Horatio.nif",
		"FilenameLow": "data/Models/Ships/Ambassador/Horatio.nif",
		"Name": "USS Horatio",
