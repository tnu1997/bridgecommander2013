...
def LoadPlacements(sSetName):
	...
	# Position "DryDock4"
	kThis = App.Waypoint_Create("DryDock4", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-14.711842, -48.255119, 35.841240)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000067, 0.999953, -0.009720)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.013767, 0.009720, 0.999858)
	...
	kThis.Update(0)
	kThis = None
	# End position "DryDock4"
	
	# Position "DryDock5"
	kThis = App.Waypoint_Create("DryDock5", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(54.711842, 25.255119, 44.841240)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000067, 0.999953, 0.009720)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.013767, 0.009720, 0.999858)
	...
	kThis.Update(0)
	kThis = None
	# End position "DryDock5"

	# Position "Stayput5"
	kThis = App.Waypoint_Create("Stayput5", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(54.711842, 25.255119, 44.441240)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000067, 0.999953, 0.009720)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.013767, 0.009720, 0.999858)
	...
	kThis.Update(0)
	kThis = None
	# End position "Stayput5"
	
	# Position "Stayput1"
	kThis = App.Waypoint_Create("Stayput1", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-14.711842, -72.255119, -34.841240)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000067, 0.999953, 0.009720)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.013767, 0.009720, 0.999858)
	...
	kThis.Update(0)
	kThis = None
	# End position "Stayput1"
	
	# Position "Stayput2"
	kThis = App.Waypoint_Create("Stayput2", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(1.711842, -72.255119, -34.841240)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000067, 0.999953, 0.009720)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.013767, 0.009720, 0.999858)
