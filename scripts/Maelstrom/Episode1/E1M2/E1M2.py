...
def InitializeGlobals(pMission):
	...
	g_dAsteroidInfo	=	{
						"Asteroid 5b":  [ "Asteroid2", 	"b",	10.0,	6.3,		5.72,	8.0,	11.0,	9500],
						"Asteroid 6b":  [ "Asteroid",	"b",	5.5,	4.5,		5.72,	8.0,	11.0, 	10500],
						"Asteroid 7b":  [ "Asteroid2",	"b",	8.0,	11.4,		5.72,	8.0,	11.0, 	10000],
						"Asteroid 8e":	[ "Asteroid1",	"e",	7.5,	25.0,		6.5,	9.6,	13.5, 	12000],
						"Asteroid 9e":	[ "Asteroid2",	"e",	6.5,	35.0,		6.5,	9.6,	13.5, 	10000],
						}
...
def CreateDebris():
	...
	for pObject in lDebrisObjects:
		...
		# Set their hull value to 10000
		pHull = pObject.GetHull()
		pProp = pHull.GetProperty()
		pProp.SetMaxCondition(10000.0)
