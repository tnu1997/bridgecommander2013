...
def LoadPlacements(sSetName):
	...
	# Position "Circling Galaxy"
	kThis = App.Waypoint_Create("Circling Galaxy", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(34.326130, -23.886063, 15.916601)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.867540, -0.488582, -0.093068)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.054535, -0.092549, 0.994214)
	...
	kThis.Update(0)
	kThis = None
	# End position "Circling Galaxy"

	# Position "Circling New Orleans"
	kThis = App.Waypoint_Create("Circling New Orleans", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-115.326130, -64.886063, 45.916601)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.867540, -0.488582, -0.093068)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.054535, -0.092549, 0.994214)
	...
	kThis.Update(0)
	kThis = None
	# End position "Circling New Orleans"
