...
import ships.FedStarbase
import ships.Galaxy
import ships.Excalibur
import ships.Nebula
import ships.NebulaVar3
import ships.Sovereign
import ships.Geronimo
import ships.SpaceFacility
import ships.Amagon
...
def PreLoadAssets(pMission):
	...
	loadspacehelper.PreloadShip("Excalibur", 1)
...
def CreateShips():
	...
	# Create ships.
	MissionLib.CreatePlayerShip("Sovereign", pStarbase12, "player", "Player At Starbase Start")
	...
	pStarbase.EnableCollisionsWith(pPlayer, 0)
	
	pGeronimo = loadspacehelper.CreateShip("Geronimo", pStarbase12, "USS Geronimo", "Akira Start")
	...
	pExcalibur = loadspacehelper.CreateShip("Excalibur", pStarbase12, "USS Excalibur", "Ambassador Start")
	pExcalibur.SetStatic(TRUE)

	pDauntless = loadspacehelper.CreateShip("Galaxy", pStarbase12, "USS Dauntless", "Icarus Start")
	pDauntless.ReplaceTexture("data/Models/SharedTextures/Galaxy/DauntlessID_glow.tga", "defaultID_glow")
	pDauntless.ReplaceTexture("data/Models/SharedTextures/Galaxy/DauntlessID_spec.tga", "defaultID_spec")
	pDauntless.SetStatic(TRUE)

	pShogun = loadspacehelper.CreateShip("NebulaVar3", pStarbase12, "USS Shogun", "Circling Nebula")
	...
	pGalaxy = loadspacehelper.CreateShip("Galaxy", pStarbase12, "USS Galaxy", "Circling Galaxy")
	pGalaxy.ReplaceTexture("data/Models/SharedTextures/Galaxy/GalaxyID_glow.tga", "defaultID_glow")
	pGalaxy.ReplaceTexture("data/Models/SharedTextures/Galaxy/GalaxyID_spec.tga", "defaultID_spec")
	
	pNebula = loadspacehelper.CreateShip("Nebula", pStarbase12, "USS Nebula", "Circling New Orleans")
	pNebula.ReplaceTexture("data/Models/SharedTextures/Nebula/NebulaID_glow.tga", "defaultID_glow")
	pNebula.ReplaceTexture("data/Models/SharedTextures/Nebula/NebulaID_spec.tga", "defaultID_spec")
	
	import E3M1NebulaAI
	# Set AIs
	for pShip in [pShogun, pNebula, pGalaxy]:
		pShip.SetAI(E3M1NebulaAI.CreateAI(pShip))
	
	loadspacehelper.CreateShip("SpaceFacility", pSavoy1, "Savoy Station", "Station Location")
	pAmagon = loadspacehelper.CreateShip("Amagon", pSavoy1, "Asteroid Amagon", "Amagon")
...
def SetAffiliations(pMission):
	...
	pFriendlies.AddName("USS Galaxy")
...
#		print pcName + " destroyed."
		...
		if (pcName == "USS Excalibur" or pcName == "USS Dauntless" or pcName == "USS Shogun" or pcName == "USS Geronimo" or pcName == "USS Galaxy" or pcName == "USS Nebula"):
			pSeq = MissionLib.NewDialogueSequence()
...
def MacCrayWarpIn(pAction):
	...
	pGeronimo = loadspacehelper.CreateShip("Geronimo", pSavoy1, "USS Geronimo", "Geronimo Start", 1)
	pGeronimo.ReplaceTexture("data/Models/SharedTextures/Akira/GeronimoID_glow.tga", "akID_glow")
	pGeronimo.ReplaceTexture("data/Models/SharedTextures/Akira/GeronimoID_specular.tga", "akID_specular")
