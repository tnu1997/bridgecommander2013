...
def LoadPlacements(sSetName):
	...
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(5.036129, 144.948226, 0.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.679576, 0.000000, 0.733605)
	...
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(38.036129, 78.948226, 0.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.679576, 0.000000, 0.733605)
	...
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(24.303711, 84.456039, 0.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.214912, -0.931947, -0.292042)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.806941, 0.001000, 0.590632)
	...
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(-12.102533, 155.108383, 67.391998)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.929755, -0.136669, -0.341872)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.288859, 0.304972, 0.907498)
	...
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(25.026367, 83.557601, 0.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.764617, 0.602100, -0.229862)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.365715, 0.111672, 0.924003)
	...
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(75.026367, 111.557601, 0.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.764617, -0.602100, 0.229862)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.365715, 0.111672, 0.924003)
