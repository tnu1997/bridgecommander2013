...
def LoadPlacements(sSetName):
	...
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(32.604484, 79.553695, 0.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	...
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(99.604484, 128.553695, 0.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.966905, 0.000000, -0.255136)
	...
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(61.51075, 106.174789, 12.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.546690, 0.815563, 0.189705)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.149788, -0.318156, 0.936130)
	...
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(34.303711, 87.456039, 33.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.214912, -0.931947, -0.292042)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.806941, 0.001000, 0.590632)
	...
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(-22.102533, 111.108383, 44.391998)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.929755, -0.136669, -0.341872)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.288859, 0.304972, 0.907498)
	...
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(65.026367, 93.557601, 5.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.764617, 0.602100, -0.229862)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.365715, 0.111672, 0.924003)
	...
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(88.026367, 111.557601, -5.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.764617, -0.602100, -0.229862)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.365715, -0.111672, -0.924003)
