...
def CreateAI(pShip):
	...
	pAttackEnemies = AI.Compound.BasicAttack.CreateAI(pShip, "Galor 1", "Galor 2", "Galor 3", "Galor 4", "Galor 5", "Galor 6", "Keldon 1",
		"Keldon 2", "Keldon 3", Difficulty = 0.75, UseCloaking = 1)
