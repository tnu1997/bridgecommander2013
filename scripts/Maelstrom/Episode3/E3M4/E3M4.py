...
def Initialize(pMission):
	...
	pBerkeley = loadspacehelper.CreateShip("Berkeley2", pStarbase, "USS Berkeley", "Berkeley Docked")
	pBerkeley.ReplaceTexture("data/Models/SharedTextures/Nebula/BerkeleyID_glow.tga", "defaultID_glow")
	pBerkeley.ReplaceTexture("data/Models/SharedTextures/Nebula/BerkeleyID_spec.tga", "defaultID_spec")
	
	import Maelstrom.Episode3.E3M2.DamageBerkeley
	Maelstrom.Episode3.E3M2.DamageBerkeley.AddDamage(pBerkeley)
	MissionLib.DamageShip("USS Berkeley", 0.25, 0.65)
	MissionLib.SetConditionPercentage(pBerkeley.GetHull(), .55)

	pBerkeley.SetStatic(TRUE)

	pNightingale = loadspacehelper.CreateShip("NebulaVar4", pStarbase, "USS Nightingale", "Nightingale Start")
	pNightingale.ReplaceTexture("data/Models/SharedTextures/Nebula/NightingaleID_glow.tga", "defaultID_glow")
	pNightingale.ReplaceTexture("data/Models/SharedTextures/Nebula/NightingaleID_spec.tga", "defaultID_spec")
	
	pIntrepid = loadspacehelper.CreateShip("LCIntrepid", pStarbase, "USS Fitzgerald", "Circling Nebula")
	...
	pIntrepid.SetAlertLevel(App.ShipClass.YELLOW_ALERT)
	...
	pIntrepid.SetAI(Maelstrom.Episode3.E3M4.PeregrineAI.CreateAI(pIntrepid))
...
def SetAffiliations(pMission):
	...
	g_pFriendlies.AddName("Generex")
	g_pFriendlies.AddName("Dvorak")
...
#	print "Starting part two"
	...
	MissionLib.DamageShip("Krayvis", 0.025, 0.05, 1)
...
#	print "Starting part three"
	# In this part, we create the flight of Warbirds and the Cardassian armada
	...
	pWarbird3 = loadspacehelper.CreateShip("Warbird", pSet, "Generex", "Generex")
	pWarbird4 = loadspacehelper.CreateShip("Warbird", pSet, "Dvorak", "Dvorak")
	
	MissionLib.MakeEnginesInvincible(pWarbird1)
	MissionLib.MakeEnginesInvincible(pWarbird3)
	MissionLib.MakeEnginesInvincible(pWarbird4)
	
	pGalor1 = loadspacehelper.CreateShip("Galor", pSet, "Galor 1", "Galor 1")
	DamageGalor1.AddDamage(pGalor1)
	MissionLib.DamageShip("Galor 1", 0.05, 0.25, 0, 0, 1, 1)

	pGalor2 = loadspacehelper.CreateShip("Galor", pSet, "Galor 2", "Galor 2")
	DamageGalor2.AddDamage(pGalor2)
	MissionLib.DamageShip("Galor 2", 0.10, 0.35, 0, 0, 1, 1)

	pGalor3 = loadspacehelper.CreateShip("Galor", pSet, "Galor 3", "Galor 3")
	DamageGalor3.AddDamage(pGalor3)
	MissionLib.DamageShip("Galor 3", 0.05, 0.15, 0, 1, 1, 1)

	pGalor4 = loadspacehelper.CreateShip("Galor", pSet, "Galor 4", "Galor 4")
	DamageGalor1.AddDamage(pGalor4)
	MissionLib.DamageShip("Galor 3", 0.15, 0.40, 0, 0, 1, 1)

	pGalor5 = loadspacehelper.CreateShip("Galor", pSet, "Galor 5", "Galor 5")
	pGalor6 = loadspacehelper.CreateShip("Galor", pSet, "Galor 6", "Galor 6")

	pKeldon1 = loadspacehelper.CreateShip("Keldon", pSet, "Keldon 1", "Keldon 1")
	pKeldon2 = loadspacehelper.CreateShip("Keldon", pSet, "Keldon 2", "Keldon 2")
	
	pKeldon3 = loadspacehelper.CreateShip("Keldon", pSet, "Keldon 3", "Keldon 3")
	DamageGalor2.AddDamage(pKeldon3)
	MissionLib.DamageShip("Keldon 3", 0.05, 0.10, 0, 0, 1, 1)

	import DamageTerrik
	DamageTerrik.AddDamage(pWarbird1)
	MissionLib.DamageShip("Chairo", 0.05, 0.25, 1, 0, 0, 1)
	import DamageWarbird
	DamageWarbird.AddDamage(pWarbird2)
	MissionLib.DamageShip("T'Awsun", 0.35, 0.55, 0, 0, 0, 1)
	DamageWarbird.AddDamage(pWarbird3)
	MissionLib.DamageShip("Generex", 0.05, 0.10, 0, 0, 0, 1)
	DamageWarbird.AddDamage(pWarbird4)
	MissionLib.DamageShip("Dvorak", 0.35, 0.45, 0, 1, 0, 1)
...
def DoBattleSequence ():
	...
	pWarbird3 = App.ShipClass_GetObject( App.SetClass_GetNull(), "Generex")
	pWarbird4 = App.ShipClass_GetObject( App.SetClass_GetNull(), "Dvorak")
	...
	pGalor4 = App.ShipClass_GetObject( App.SetClass_GetNull(), "Galor 4")
	pGalor5 = App.ShipClass_GetObject( App.SetClass_GetNull(), "Galor 5")
	pGalor6 = App.ShipClass_GetObject( App.SetClass_GetNull(), "Galor 6")
	pKeldon1 = App.ShipClass_GetObject( App.SetClass_GetNull(), "Keldon 1")
	pKeldon2 = App.ShipClass_GetObject( App.SetClass_GetNull(), "Keldon 2")
	pKeldon3 = App.ShipClass_GetObject( App.SetClass_GetNull(), "Keldon 3")
	...
	pWarbird3.SetAI(Maelstrom.Episode3.E3M4.E3M4DeadWarbirdAI.CreateAI(pWarbird3))
	pWarbird4.SetAI(Maelstrom.Episode3.E3M4.E3M4DeadWarbirdAI.CreateAI(pWarbird4))
	...
	pGalor4.SetAI(Maelstrom.Episode3.E3M4.E3M4BasicGalorAI.CreateAI(pGalor4))
	pGalor5.SetAI(Maelstrom.Episode3.E3M4.E3M4BasicGalorAI.CreateAI(pGalor5))
	pGalor6.SetAI(Maelstrom.Episode3.E3M4.E3M4BasicGalorAI.CreateAI(pGalor6))
	pKeldon1.SetAI(Maelstrom.Episode3.E3M4.E3M4BasicGalorAI.CreateAI(pKeldon1))
	pKeldon2.SetAI(Maelstrom.Episode3.E3M4.E3M4BasicGalorAI.CreateAI(pKeldon2))
	pKeldon3.SetAI(Maelstrom.Episode3.E3M4.E3M4BasicGalorAI.CreateAI(pKeldon3))
...
def TerrikKilled (pObject, pEvent):
	...
	if (pShip):
		pShip.SetAI(Maelstrom.Episode3.E3M4.E3M4WarpOutAI.CreateAI(pShip))
	pShip = App.ShipClass_GetObject(None, "Galor 4")
	if (pShip):
		pShip.SetAI(Maelstrom.Episode3.E3M4.E3M4WarpOutAI.CreateAI(pShip))
	pShip = App.ShipClass_GetObject(None, "Galor 5")
	if (pShip):
		pShip.SetAI(Maelstrom.Episode3.E3M4.E3M4WarpOutAI.CreateAI(pShip))
	pShip = App.ShipClass_GetObject(None, "Galor 6")
	if (pShip):
		pShip.SetAI(Maelstrom.Episode3.E3M4.E3M4WarpOutAI.CreateAI(pShip))
	pShip = App.ShipClass_GetObject(None, "Keldon 1")
	if (pShip):
		pShip.SetAI(Maelstrom.Episode3.E3M4.E3M4WarpOutAI.CreateAI(pShip))
	pShip = App.ShipClass_GetObject(None, "Keldon 2")
	if (pShip):
		pShip.SetAI(Maelstrom.Episode3.E3M4.E3M4WarpOutAI.CreateAI(pShip))
	pShip = App.ShipClass_GetObject(None, "Keldon 3")
	if (pShip):
		pShip.SetAI(Maelstrom.Episode3.E3M4.E3M4WarpOutAI.CreateAI(pShip))
	pShip = App.ShipClass_GetObject(None, "Generex")
	if (pShip):
		pShip.SetAI(Maelstrom.Episode3.E3M4.E3M4WarpOutAI.CreateAI(pShip))
	pShip = App.ShipClass_GetObject(None, "Dvorak")
	if (pShip):
		pShip.SetAI(Maelstrom.Episode3.E3M4.E3M4WarpOutAI.CreateAI(pShip))
...
def TerrikApology():
	...
	pAction = App.TGScriptAction_Create("MissionLib", "EndCutscene")
	pSequence.AppendAction (pAction)
	pAction = App.CharacterAction_Create(pTact, App.CharacterAction.AT_SAY_LINE, "E3M4WarbirdsWarpOut", None, 0, g_pMissionDatabase)
	pSequence.AppendAction (pAction)
...
def HailHandler(pObject, pEvent):
	...
	if (pcTargetName == "Galor 1" or pcTargetName == "Galor 2" or pcTargetName == "Galor 3" or pcTargetName == "Galor 4" or pcTargetName == "Galor 5"
		or pcTargetName == "Galor 6" or pcTargetName == "Keldon 1" or pcTargetName == "Keldon 2" or pcTargetName == "Keldon 3"):
