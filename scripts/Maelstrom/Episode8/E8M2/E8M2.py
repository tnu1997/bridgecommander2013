...
def PreLoadAssets(pMission):
	...
	if Maelstrom.Maelstrom.bZeissAlive:
		loadspacehelper.PreloadShip("SanFrancisco2", 1)
	loadspacehelper.PreloadShip("Vorcha2", 1)
	...
	loadspacehelper.PreloadShip("Keldon", 14)
...
#			DebugPrint(__name__ + " error: Unable to get Command Fleet menu.")
	...
	pEnemies.AddName("Keldon10")
	pEnemies.AddName("Keldon11")
	pEnemies.AddName("Keldon12")
	pEnemies.AddName("Keldon13")
	pEnemies.AddName("Keldon14")
	...
	pKeldonGroup.AddName("Keldon8")
	pKeldonGroup.AddName("Keldon9")
	pKeldonGroup.AddName("Keldon10")
	pKeldonGroup.AddName("Keldon11")
	pKeldonGroup.AddName("Keldon12")
	pKeldonGroup.AddName("Keldon13")
	pKeldonGroup.AddName("Keldon14")
...
#					DebugPrint ("Creating OD5 ships.\n")
					...
					pKeldon8 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon8", "Kessok11 Start" )
					pKeldon9 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon9", "Kessok12 Start" )	
					pKeldon10 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon10", "Kessok13 Start" )	
					pKeldon11 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon11", "Kessok14 Start" )	
					pKeldon12 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon12", "Kessok15 Start" )
					pKeldon13 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon13", "Kessok16 Start" )	
					pKeldon14 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon14", "Kessok17 Start" )	
...
#					DebugPrint ("Making " + sShipName + " stay put.")
			...
			if (sShipName == "Keldon1") or (sShipName == "Keldon2") or (sShipName == "Keldon3") or (sShipName == "Keldon4") or (sShipName == "Keldon5") or (sShipName == "Keldon8") or (sShipName == "Keldon9") or (sShipName == "Keldon10") or (sShipName == "Keldon11") or (sShipName == "Keldon12") or (sShipName == "Keldon13") or (sShipName == "Keldon14"):
				if iOD5Keldons == 1:
...
#	DebugPrint ("Adding GetMatanGoal")
	...
	fStartTime = App.g_kUtopiaModule.GetGameTime()
	MissionLib.CreateTimer(ET_PICARD_TIMER, __name__ + ".PicardExMachina", fStartTime + 90, 0, 0)
...
#	DebugPrint ("Picard Ex Machina")
	...
	pEnterprise = loadspacehelper.CreateShip("EnterpriseE", pSet, "USS Enterprise", "Akira Start", 1 )
...
#	DebugPrint("Zeiss warping in")
	...
	if bMacCrayChosen == TRUE:
		pGalaxy = loadspacehelper.CreateShip("SanFrancisco2", pSet, "USS San Francisco", "Nebula Start", 1)
		pGalaxy.ReplaceTexture("data/Models/SharedTextures/Galaxy/SanFranciscoID_glow.tga", "defaultID_glow")
		pGalaxy.ReplaceTexture("data/Models/SharedTextures/Galaxy/SanFranciscoID_spec.tga", "defaultID_spec")
	else:
		pGalaxy = loadspacehelper.CreateShip("SanFrancisco2", pSet, "USS San Francisco", "Akira Start", 1)
		pGalaxy.ReplaceTexture("data/Models/SharedTextures/Galaxy/SanFranciscoID_glow.tga", "defaultID_glow")
		pGalaxy.ReplaceTexture("data/Models/SharedTextures/Galaxy/SanFranciscoID_spec.tga", "defaultID_spec")
...
#	DebugPrint("Korbus warping in")
	...
	if bZeissChosen == TRUE or bMacCrayChosen == TRUE:
		pVorcha = loadspacehelper.CreateShip("Vorcha2", pSet, "JonKa", "Nebula Start", 1)
	else:
		pVorcha = loadspacehelper.CreateShip("Vorcha2", pSet, "JonKa", "Akira Start", 1)
...
#	DebugPrint("Setting OD5 AI")
	...
	if bOD5Flag == HASNT_ARRIVED:
		...
		if not (pKeldon == None):
			pKeldon.SetAI(EnemyAI.CreateAI(pKeldon))
		pKeldon = App.ShipClass_GetObject(pSet, "Keldon8")
		if not (pKeldon == None):
			pKeldon.SetAI(EnemyAI.CreateAI(pKeldon))
		pKeldon = App.ShipClass_GetObject(pSet, "Keldon9")
		if not (pKeldon == None):
			pKeldon.SetAI(EnemyAI.CreateAI(pKeldon))
		pKeldon = App.ShipClass_GetObject(pSet, "Keldon10")
		if not (pKeldon == None):
			pKeldon.SetAI(EnemyAI.CreateAI(pKeldon))
		pKeldon = App.ShipClass_GetObject(pSet, "Keldon11")
		if not (pKeldon == None):
			pKeldon.SetAI(EnemyAI.CreateAI(pKeldon))
		pKeldon = App.ShipClass_GetObject(pSet, "Keldon12")
		if not (pKeldon == None):
			pKeldon.SetAI(EnemyAI.CreateAI(pKeldon))
		pKeldon = App.ShipClass_GetObject(pSet, "Keldon13")
		if not (pKeldon == None):
			pKeldon.SetAI(EnemyAI.CreateAI(pKeldon))
		pKeldon = App.ShipClass_GetObject(pSet, "Keldon14")
		if not (pKeldon == None):
			pKeldon.SetAI(EnemyAI.CreateAI(pKeldon))
...
#	DebugPrint("Keldons Warping to OD3")
	...
	pKeldon = App.ShipClass_GetObject(pSet, "Keldon8")
	if pKeldon:
		pKeldon.SetAI(WarpToOD3AI.CreateAI(pKeldon, 5, "Attacker 25 Start"))
	pKeldon = App.ShipClass_GetObject(pSet, "Keldon9")
	if pKeldon:
		pKeldon.SetAI(WarpToOD3AI.CreateAI(pKeldon, 6, "Attacker 26 Start"))
	pKeldon = App.ShipClass_GetObject(pSet, "Keldon10")
	if pKeldon:
		pKeldon.SetAI(WarpToOD3AI.CreateAI(pKeldon, 7, "Attacker 27 Start"))
	pKeldon = App.ShipClass_GetObject(pSet, "Keldon11")
	if pKeldon:
		pKeldon.SetAI(WarpToOD3AI.CreateAI(pKeldon, 8, "Attacker 28 Start"))
	pKeldon = App.ShipClass_GetObject(pSet, "Keldon12")
	if pKeldon:
		pKeldon.SetAI(WarpToOD3AI.CreateAI(pKeldon, 9, "Attacker 29 Start"))
	pKeldon = App.ShipClass_GetObject(pSet, "Keldon13")
	if pKeldon:
		pKeldon.SetAI(WarpToOD3AI.CreateAI(pKeldon, 8, "Attacker 30 Start"))
	pKeldon = App.ShipClass_GetObject(pSet, "Keldon14")
	if pKeldon:
		pKeldon.SetAI(WarpToOD3AI.CreateAI(pKeldon, 9, "Attacker 31 Start"))		
...
def SwitchOutOfMovieMode (pAction):
#	DebugPrint("Switching out of movie mode")
