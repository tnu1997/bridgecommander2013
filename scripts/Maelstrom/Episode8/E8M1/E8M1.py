...
#	DebugPrint ("Creating ships.\n")
	...
	if Maelstrom.Maelstrom.bZeissAlive:
		pGalaxy = loadspacehelper.CreateShip("SanFrancisco2", pSet, "USS San Francisco", "Enterprise Start")
...
#		DebugPrint("DataInfo plays")
		...
		pSequence.AppendAction(pAction)
                pAction = App.CharacterAction_Create(pData, App.CharacterAction.AT_SAY_LINE, "E8M1L227", None, 0, pMissionDatabase)
		pSequence.AppendAction(pAction)
