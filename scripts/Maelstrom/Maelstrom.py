...
import Foundation
###############################################################################
#	I strongly recommend that you not tamper with any of the Maelstrom
#	scripts unless you're a very experienced scripter.  Do not tamper
#	with any unusual ship hardpoints that are mission-specific.  Do not
#	tamper with the Sovereign hardpoint at all - it is specially scripted
#	for many missions.  Do not tamper with any Federation torpedo scripts.
#	
#	-CR
###############################################################################
