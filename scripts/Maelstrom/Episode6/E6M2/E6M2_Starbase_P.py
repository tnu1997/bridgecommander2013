...
def LoadPlacements(sSetName):
	...
	# Position "IntrepidStart"
	kThis = App.Waypoint_Create("IntrepidStart", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-89.339870, 120.544128, 57.406374)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.983927, -0.118146, -0.133897)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.136359, -0.012970, 0.990575)
	...
	kThis.Update(0)
	kThis = None
	# End position "IntrepidStart"
	
	# Position "PromStart"
	kThis = App.Waypoint_Create("PromStart", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(89.339870, 110.544128, 79.406374)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.983927, 0.118146, -0.133897)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.136359, -0.012970, 0.990575)
