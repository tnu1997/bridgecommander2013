...
def PreLoadAssets(pMission):
	...
	loadspacehelper.PreloadShip("E6M2NebulaVar4", 1)
...
#	kDebugObj.Print("Initializing global variables")
	...
	g_lFriendlyShips	= 	[
							"Starbase 12", "Nightingale", "Dauntless", "Escape Pod 1", "Escape Pod 2", "Escape Pod 3", "Escape Pod 4", "Escape Pod 5", "Escape Pod 6", "USS Shogun", "USS Prometheus"
							]
...
def CreateStartingObjects(pMission):
	...
	pFriendlies.AddName("USS Shogun")
	...
	pEnemies.AddName("Custom Keldon")
	...
	pNight		= loadspacehelper.CreateShip("E6M2NebulaVar4", pGeble4Set, "Nightingale", "NightEnter")
	...
	MissionLib.HideSubsystems(pNight)
	
	pHulk1		= loadspacehelper.CreateShip("Galaxy", pGeble3Set, "Hulk 1", "Derelict1Start")
	pHulk1.ReplaceTexture("data/Models/SharedTextures/Galaxy/PangaeaID_glow.tga", "defaultID_glow")
	pHulk1.ReplaceTexture("data/Models/SharedTextures/Galaxy/PangaeaID_spec.tga", "defaultID_spec")
	
	pHulk2		= loadspacehelper.CreateShip("Nebula", pGeble3Set, "Hulk 2", "Derelict2Start")
	pHulk2.ReplaceTexture("data/Models/SharedTextures/Nebula/MerrimackID_glow.tga", "defaultID_glow")
	pHulk2.ReplaceTexture("data/Models/SharedTextures/Nebula/MerrimackID_spec.tga", "defaultID_spec")
	
	pHulk3		= loadspacehelper.CreateShip("Galaxy", pGeble3Set, "Hulk 3", "Derelict3Start")
	pHulk3.ReplaceTexture("data/Models/SharedTextures/Galaxy/PangaeaID_glow.tga", "defaultID_glow")
	pHulk3.ReplaceTexture("data/Models/SharedTextures/Galaxy/PangaeaID_spec.tga", "defaultID_spec")
	
	for pObject in [pHulk1, pHulk2, pHulk3]:
		pObject.SetHailable(0)
		pObject.DisableGlowAlphaMaps()
	
	pShogun	= loadspacehelper.CreateShip("NebulaVar3", pStarbaseSet, "USS Shogun", "IntrepidStart")
	pShogun.ReplaceTexture("data/Models/SharedTextures/Nebula/ShogunID_glow.tga", "defaultID_glow")
	pShogun.ReplaceTexture("data/Models/SharedTextures/Nebula/ShogunID_spec.tga", "defaultID_spec")
	
	pProm		= loadspacehelper.CreateShip("Prometheus", pStarbaseSet, "USS Prometheus", "PromStart")
	...
	pShogun.SetAI(Maelstrom.Episode3.E3M4.PeregrineAI.CreateAI(pShogun))
	pProm.SetAI(Maelstrom.Episode3.E3M4.PeregrineAI.CreateAI(pProm))
...
#	kDebugObj.Print("Object \"%s\" entered set \"%s\"" % (sShipName, sSetName))
	...
	if (sShipName == "Custom Keldon") and (sSetName == "Serris1"):
		GalorsEnterSerris1()
...
#	kDebugObj.Print("Scanning the hulk, finding torps")
	...
	#first, find out if the user has 100 quantums already.
	pPlayer = MissionLib.GetPlayer()
	if (pPlayer == None):
		return
	...
	if (iNumQuantumsLeft != 100):
		...
		pTransTorps		= App.TGScriptAction_Create("MissionLib", "LoadTorpedoes", "Quantum", 25)
                pEnableScanMenu         = App.TGScriptAction_Create("Bridge.BridgeUtils", "EnableScanMenu")
...
def CreateDauntless():
	...
	pShip.ReplaceTexture("data/Models/SharedTextures/Galaxy/dauntlessID_glow.tga", "defaultID_glow")
	pShip.ReplaceTexture("data/Models/SharedTextures/Galaxy/dauntlessID_spec.tga", "defaultID_spec")
...
#	kDebugObj.Print ("Making Galor 1's Impulse and Warp Engines NOT invincible.")
	...
	pKeldon1 = loadspacehelper.CreateShip("MatanKeldon2", pSet, "Custom Keldon", "Galor2Start")
	
	pTorps = pKeldon1.GetTorpedoSystem()
...
##
## This function will cause the dauntless to self-distruct.
##
## Args: pTGAction	- The script action object.
##
