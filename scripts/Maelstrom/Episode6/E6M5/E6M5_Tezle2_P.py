...
def LoadPlacements(sSetName):
	...
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(-71.182453, -350.760376, -32.840000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	# Position "Galor77Start"
	kThis = App.Waypoint_Create("Galor77Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(-60.930107, -313.192596, -39.288002)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.002013, 0.999998, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.Update(0)
	kThis = None
	# End position "Galor77Start"
	
	# Position "Galor88Start"
	kThis = App.Waypoint_Create("Galor88Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(-78.930107, -335.192596, -50.288002)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.002013, 0.999998, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
