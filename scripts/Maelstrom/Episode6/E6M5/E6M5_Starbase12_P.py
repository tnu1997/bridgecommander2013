...
def LoadPlacements(sSetName):
	...
	# Position "MagellanStart"
	kThis = App.Waypoint_Create("MagellanStart", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(-132.698929, 64.717216, -12.216973)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.865081, -0.491518, 0.100226)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.115058, -0.000054, 0.993359)
