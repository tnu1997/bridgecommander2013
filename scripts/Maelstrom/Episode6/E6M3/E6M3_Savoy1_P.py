...
def LoadPlacements(sSetName):
	...
	# Position "Keldon77Enter"
	kThis = App.Waypoint_Create("Keldon77Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-94.790245, -202.405441, 12.500576)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.989264, -0.093194, -0.112571)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.107517, -0.057603, 0.992533)
	...
	kThis.Update(0)
	kThis = None
	# End position "Keldon77Enter"

	# Position "Galor1Enter"
	kThis = App.Waypoint_Create("Galor1Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-101.366386, -211.308594, 0.000000)
	kForward = App.TGPoint3()
	...
	# Position "Galor55Enter"
	kThis = App.Waypoint_Create("Galor55Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-98.802910, -220.620117, 5.000000)
	kForward = App.TGPoint3()
	...
	kThis.Update(0)
	kThis = None
	# End position "Galor55Enter"
	
	# Position "Galor66Enter"
	kThis = App.Waypoint_Create("Galor66Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-107.366386, -210.308594, -5.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.995339, -0.000113, 0.096440)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.096293, -0.056438, 0.993752)
	...
	kThis.Update(0)
	kThis = None
	# End position "Galor66Enter"

	# Position "Galor2Enter"
	kThis = App.Waypoint_Create("Galor2Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-98.802910, -235.620117, 0.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.990424, -0.001083, 0.138055)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.137962, -0.045307, 0.989401)
	...
	# Position "Keldon55Enter"
	kThis = App.Waypoint_Create("Keldon55Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(272.278259, 240.432434, 12.532455)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.139655, 0.909510, -0.391520)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.812231, 0.331377, -0.480073)
	...
	kThis.Update(0)
	kThis = None
	# End position "Keldon55Enter"
	
	# Position "Keldon66Enter"
	kThis = App.Waypoint_Create("Keldon66Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(200.278259, 230.432434, 21.532455)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.139655, -0.909510, 0.391520)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.812231, 0.331377, -0.480073)
	...
	kThis.Update(0)
	kThis = None
	# End position "Keldon66Enter"

	# Position "Keldon5Enter"
	kThis = App.Waypoint_Create("Keldon5Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(272.278259, 240.432434, -10.532455)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.139655, -0.909510, -0.391520)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.812231, 0.331377, -0.480073)
	...
	# Position "Galor777Enter"
	kThis = App.Waypoint_Create("Galor777Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(229.159958, 195.534180, 10.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.017103, -0.999835, 0.006119)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.239049, 0.001853, 0.971006)
	...
	kThis.Update(0)
	kThis = None
	# End position "Galor777Enter"
	
	# Position "Galor888Enter"
	kThis = App.Waypoint_Create("Galor888Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(229.159958, 195.534180, 20.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.017103, -0.999835, 0.006119)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.239049, 0.001853, 0.971006)
	...
	kThis.Update(0)
	kThis = None
	# End position "Galor888Enter"

	# Position "Galor999Enter"
	kThis = App.Waypoint_Create("Galor999Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(260.159958, 175.534180, 0.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.017103, -0.999835, 0.006119)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.239049, 0.001853, 0.971006)
