...
def LoadPlacements(sSetName):
	...
	# Position "Galor55Start"
	kThis = App.Waypoint_Create("Galor55Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(222.501053, 222.688965, 7.570793)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.725896, 0.687625, 0.015679)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.048941, -0.028899, 0.998384)
	...
	kThis.Update(0)
	kThis = None
	# End position "Galor55Start"

	# Position "Galor66Start"
	kThis = App.Waypoint_Create("Galor66Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(231.023148, 210.235565, 23.870026)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.686998, -0.683270, -0.247336)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.311671, 0.030410, 0.949703)
	...
	# Position "Keldon77Start"
	kThis = App.Waypoint_Create("Keldon77Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(205.294067, 205.515503, 40.561438)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.709576, -0.680985, 0.181004)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.303579, 0.063637, 0.950679)
