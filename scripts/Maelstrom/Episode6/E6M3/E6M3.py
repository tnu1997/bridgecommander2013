...
#	Modified:	9/15/05 -	Bryan Cook (BC Super Mod V2.0)
###############################################################################
import App
...
def PreLoadAssets(pMission):
	...
	loadspacehelper.PreloadShip("NebulaVar4", 1)
	loadspacehelper.PreloadShip("FedStarbase", 1)
	loadspacehelper.PreloadShip("SpaceFacility", 1)
	loadspacehelper.PreloadShip("SanFrancisco", 1)
	loadspacehelper.PreloadShip("Venture", 1)
...
#	kDebugObj.Print("Initializing global variables")
	...
	g_lFedShipNames	= 	[
						"player", "Khitomer", "San Francisco", "Devore", "Venture", "Nightingale", "USS Defiant", "USS Nebula"
						]
	
	global g_lCardShipNames
	g_lCardShipNames	=	[
							"Galor 1", "Galor 2", "Galor 3", "Galor 4", "Galor 5", "Galor 6", "Galor 7", "Galor 8",
							"Galor 9", "Keldon 1", "Keldon 2", "Keldon 3", "Keldon 4", "Keldon 5", "Keldon 6"
							]
	
	global g_lSavoy3CardShipNames
	g_lSavoy3CardShipNames	=	[
							"Galor 1", "Galor 2", "Keldon 1", "Keldon 5", "Galor 5", "Galor 6"
							]
	...
	g_lFriendlyShips =	[
						"Starbase 12", "Khitomer", "San Francisco", "Devore", "Venture", "Nightingale", "Shuttle 1", "Shuttle 2", "Shuttle 3", "USS Defiant", "USS Nebula"
						]
	# Target list globals
...
def CreateStartingObjects(pMission):
	...
	pNight	= loadspacehelper.CreateShip("NebulaVar4", pDeepSpaceSet, "Nightingale", "NightStart")
	pNight.ReplaceTexture("data/Models/SharedTextures/Nebula/NightingaleID_glow.tga", "defaultID_glow")
	pNight.ReplaceTexture("data/Models/SharedTextures/Nebula/NightingaleID_spec.tga", "defaultID_spec")
	...
	pStarbase12.SetAlertLevel(App.ShipClass.GREEN_ALERT)
	
	pKhitomer	= loadspacehelper.CreateShip("Nebula", pStarbaseSet, "Khitomer", "KhitStart")
	pKhitomer.ReplaceTexture("data/Models/SharedTextures/Nebula/KhitomerID_glow.tga", "defaultID_glow")
	pKhitomer.ReplaceTexture("data/Models/SharedTextures/Nebula/KhitomerID_spec.tga", "defaultID_spec")

	pSavoyStation	= loadspacehelper.CreateShip("SpaceFacility", pSavoy1Set, "Savoy Station", "Station Location")
	
	pNeb	= loadspacehelper.CreateShip("Nebula", pStarbaseSet, "USS Nebula", "New Orleans Start")
	pNeb.ReplaceTexture("data/Models/SharedTextures/Nebula/NebulaID_glow.tga", "defaultID_glow")
	pNeb.ReplaceTexture("data/Models/SharedTextures/Nebula/NebulaID_spec.tga", "defaultID_spec")
	
	pDefiant	= loadspacehelper.CreateShip("Defiant", pStarbaseSet, "USS Defiant", "Defiant Start")
	
	# Make the Defiant and Rutledge warp out
	import Maelstrom.Episode3.E3M4.PeregrineAI
	pNeb.SetAI(Maelstrom.Episode3.E3M4.PeregrineAI.CreateAI(pNeb))
	pDefiant.SetAI(Maelstrom.Episode3.E3M4.PeregrineAI.CreateAI(pDefiant))
	...
	if (g_bVentureDestroyed == FALSE):
		pVenture = loadspacehelper.CreateShip("Venture", pStarbaseSet, "Venture", "VentureStart")
		pVenture.ReplaceTexture("data/Models/SharedTextures/Galaxy/VentureID_glow.tga", "defaultID_glow")
		pVenture.ReplaceTexture("data/Models/SharedTextures/Galaxy/VentureID_spec.tga", "defaultID_spec")
		pVenture.SetAI(E6M3_AI_Stay.CreateAI(pVenture))
	if (g_bSFDestroyed == FALSE):
		pSanFrancisco = loadspacehelper.CreateShip("SanFrancisco", pStarbaseSet, "San Francisco", "SFStart")
		pSanFrancisco.ReplaceTexture("data/Models/SharedTextures/Galaxy/SanFranciscoID_glow.tga", "defaultID_glow")
		pSanFrancisco.ReplaceTexture("data/Models/SharedTextures/Galaxy/SanFranciscoID_spec.tga", "defaultID_spec")
	...
	if (g_bDevoreDestroyed == FALSE):
		...
		pDevore.ReplaceTexture("data/Models/SharedTextures/Akira/DevoreID_glow.tga", "akID_glow")
		pDevore.ReplaceTexture("data/Models/SharedTextures/Akira/DevoreID_specular.tga", "akID_specular")
	...
	pGalor5		= loadspacehelper.CreateShip("Galor", pSavoy3Set, "Galor 5", "Galor55Start")
	pGalor6		= loadspacehelper.CreateShip("Galor", pSavoy3Set, "Galor 6", "Galor66Start")
	pKeldon1	= loadspacehelper.CreateShip("Keldon", pSavoy3Set, "Keldon 1", "Keldon1Start")
	pKeldon5	= loadspacehelper.CreateShip("Keldon", pSavoy3Set, "Keldon 5", "Keldon77Start")

	# Make these ship's impulse and warp engines invincible so they can escape.
#	kDebugObj.Print ("Making Impulse and Warp Engines invincible.")
	...
	pWarp3 = pGalor5.GetWarpEngineSubsystem()
	pImpulse3 = pGalor5.GetImpulseEngineSubsystem()
	if (pWarp3 and pImpulse3):
		MissionLib.MakeSubsystemsInvincible(pImpulse3, pWarp3)

	pWarp4 = pGalor6.GetWarpEngineSubsystem()
	pImpulse4 = pGalor6.GetImpulseEngineSubsystem()
	if (pWarp4 and pImpulse4):
		MissionLib.MakeSubsystemsInvincible(pImpulse4, pWarp4)
		
	pWarp5 = pKeldon1.GetWarpEngineSubsystem()
	pImpulse5 = pKeldon1.GetImpulseEngineSubsystem()
	if (pWarp5 and pImpulse5):
		MissionLib.MakeSubsystemsInvincible(pImpulse5, pWarp5)
		
	pWarp6 = pKeldon5.GetWarpEngineSubsystem()
	pImpulse6 = pKeldon5.GetImpulseEngineSubsystem()
	if (pWarp6 and pImpulse6):
		MissionLib.MakeSubsystemsInvincible(pImpulse6, pWarp6)
	...
	pGalor5.SetAI(E6M3_AI_Cards_Savoy3.CreateAI(pGalor5, "Galor55Enter"))
	pGalor6.SetAI(E6M3_AI_Cards_Savoy3.CreateAI(pGalor6, "Galor66Enter"))
	pKeldon1.SetAI(E6M3_AI_Cards_Savoy3.CreateAI(pKeldon1, "Keldon1Enter"))
	pKeldon5.SetAI(E6M3_AI_Cards_Savoy3.CreateAI(pKeldon5, "Keldon77Enter"))
...
def SetUpObjectAffiliations(pMission):
		...
		pFriendlies.AddName("USS Nebula")
		...
		g_pSavoy3FedsTargets.AddName("Keldon 5")
		g_pSavoy3FedsTargets.AddName("Galor 3")
		g_pSavoy3FedsTargets.AddName("Galor 5")
		g_pSavoy3FedsTargets.AddName("Galor 6")
...
#	kDebugObj.Print("Object \"%s\" destroyed." % (sShipName))
	...
	global g_bAllOtherCardsDestroyed
	if (g_iNumberCardsDestroyed == 15) and (g_bAllOtherCardsDestroyed == FALSE):
...
def CreateTransports(TGObject, pEvent):
	...
	pKeldon6	= loadspacehelper.CreateShip("Keldon", pSet, "Keldon 6", "Keldon66Enter")
	pGalor4		= loadspacehelper.CreateShip("Galor", pSet, "Galor 4", "Galor4Enter")
	pGalor7		= loadspacehelper.CreateShip("Galor", pSet, "Galor 7", "Galor777Enter")
	pGalor8		= loadspacehelper.CreateShip("Galor", pSet, "Galor 8", "Galor888Enter")
	pGalor9		= loadspacehelper.CreateShip("Galor", pSet, "Galor 9", "Galor999Enter")
	...
	pKeldon6.SetAI(E6M3_AI_Keldon3.CreateAI(pKeldon6, "Transport 1"))
	pGalor4.SetAI(E6M3_AI_Keldon3.CreateAI(pGalor4, "Transport 2"))
	pGalor7.SetAI(E6M3_AI_Keldon3.CreateAI(pGalor7, "Transport 1"))
	pGalor8.SetAI(E6M3_AI_Keldon3.CreateAI(pGalor8, "Transport 2"))
	pGalor9.SetAI(E6M3_AI_Keldon3.CreateAI(pGalor9, "Transport 1"))
...
def TransportsArriveSavoy1():
	...
	pDatabase = App.g_kLocalizationManager.Load("data/TGL/Maelstrom/Episode 6/E6M1.TGL")
	pFelixTransArrive1	= App.CharacterAction_Create(g_pFelix, App.CharacterAction.AT_SAY_LINE, "E6M1ArtrusSecondWave1a", "Captain", 1, pDatabase)
	App.g_kLocalizationManager.Unload(pDatabase)
