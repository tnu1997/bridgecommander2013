...
def LoadPlacements(sSetName):
	...
	# Position "Keldon23Enter"
	kThis = App.Waypoint_Create("Keldon23Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-280.437378, 305.106110, -10.638935)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.637212, -0.758291, 0.137681)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.063053, -0.229341, -0.971302)
	...
	kThis.Update(0)
	kThis = None
	# End position "Keldon23Enter"

	# Position "Keldon24Enter"
	kThis = App.Waypoint_Create("Keldon24Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-320.656281, 388.063141, 7.903757)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.682741, -0.715898, 0.146133)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.149323, -0.332490, -0.931210)
