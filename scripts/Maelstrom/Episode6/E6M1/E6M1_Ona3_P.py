...
def LoadPlacements(sSetName):
	...
	# Position "Card21Enter"
	kThis = App.Waypoint_Create("Card21Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(-104.803665, -182.665207, 33.424000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.Update(0)
	kThis = None
	# End position "Card21Enter"
	
	# Position "Card22Enter"
	kThis = App.Waypoint_Create("Card22Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(-114.803665, -122.665207, 2.424000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	# Position "Card13Enter"
	kThis = App.Waypoint_Create("Card13Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(-150.272614, -185.149323, 9.816002)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.Update(0)
	kThis = None
	# End position "Card13Enter"
	
	# Position "Card14Enter"
	kThis = App.Waypoint_Create("Card14Enter", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(-95.872490, -124.467651, 11.352001)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
