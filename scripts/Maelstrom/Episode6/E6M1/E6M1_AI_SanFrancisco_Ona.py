...
def CreateAI(pShip):
	...
	import AI.Compound.BasicAttack
	pBasicAttack3Keldon = AI.Compound.BasicAttack.CreateAI(pShip, "Keldon 3", "Keldon 21", "Keldon 22", Difficulty = 0.8)
	# Done creating CompoundAI BasicAttack3Keldon
	#########################################
	#########################################
	# Creating CompoundAI BasicAttack3Galors at (516, 126)
	import AI.Compound.BasicAttack
	pBasicAttack3Galors = AI.Compound.BasicAttack.CreateAI(pShip, "Galor 8", "Galor 9", "Galor 13", "Galor 14", Difficulty = 0.8)
