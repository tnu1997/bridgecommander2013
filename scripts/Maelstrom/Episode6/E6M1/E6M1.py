...
#	kDebugObj.Print("Initializing global variables")
	...
	g_lCardShipNames	= 	[ 
						...
						"Galor 9", "Galor 10", "Galor 11", "Galor 12", "Galor 13", "Galor 14", "Keldon 1", 							"Keldon 2", "Keldon 3", "Keldon 4", "Keldon 5", "Keldon 6", "Keldon 7", "Keldon 21", "Keldon 22", 
						"Keldon 23", "Keldon 24"
							]
	...
	g_lOnaCardShipNames	= 	[ 
						"Galor 5", "Galor 6", "Galor 7", "Galor 8", "Galor 9", "Galor 13", "Galor 14", "Keldon 2", "Keldon 3", "Keldon 21", "Keldon 22"
							]
...
#	kDebugObj.Print("Federation ship destroyed")
	...
	if (g_bDevoreDestroyed == TRUE) and (g_bSanFranciscoDestroyed == FALSE):
		global g_sRescueShipName
		g_sRescueShipName = "San Francisco"
...
def ObjectExitsArtrusOrOna(sShipName):
	...
	if (g_iNumberOnaCardsDestroyed == 4) and (g_bSecondOnaWaveCreated == FALSE):
	...
	elif (g_iNumberOnaCardsDestroyed == 10) and (g_bGoingToSavoy == FALSE):
...
def CreateArtrusShips():
	...
	# Create the ships
	pSanFrancisco 	= loadspacehelper.CreateShip("SanFrancisco", pSet, "San Francisco", "SFStart")
...
def CreateSecondOnaWave(TGObject, pEvent):
	...
	pGalor13	= loadspacehelper.CreateShip("Galor", pSet, "Galor 13", "Card13Enter", 1)
	pGalor14	= loadspacehelper.CreateShip("Galor", pSet, "Galor 14", "Card14Enter", 1)
	pKeldon3	= loadspacehelper.CreateShip("Keldon", pSet, "Keldon 3", "Card2Enter", 1)
	pKeldon21	= loadspacehelper.CreateShip("Keldon", pSet, "Keldon 21", "Card21Enter", 1)
	pKeldon22	= loadspacehelper.CreateShip("Keldon", pSet, "Keldon 22", "Card22Enter", 1)
	...
	pGalor13.SetAI(E6M1_AI_OnaGalor.CreateAI(pGalor13, g_pGalor8Targets))
	pGalor14.SetAI(E6M1_AI_OnaGalor.CreateAI(pGalor14, g_pGalor9Targets))
	pKeldon3.SetAI(E6M1_AI_OnaKeldon.CreateAI(pKeldon3, g_pKeldon3Targets))
	pKeldon21.SetAI(E6M1_AI_OnaKeldon.CreateAI(pKeldon21, g_pKeldon3Targets))
	pKeldon22.SetAI(E6M1_AI_OnaKeldon.CreateAI(pKeldon22, g_pKeldon3Targets))
...
def SecondOnaWaveArrives():
	...
	pFelixSecondOnaWave1	= App.CharacterAction_Create(g_pFelix, App.CharacterAction.AT_SAY_LINE, "E6M1ArtrusSecondWave1a", "Captain", 1, g_pMissionDatabase)
...
def ResetFedAIToSavoy1(pTGAction):
	...
	if ((g_bSanFranciscoDestroyed == FALSE) and (g_sRescueShipName != "San Francisco")):
...
def CreateThirdSavoyWave(TGObject, pEvent):
	...
	pKeldon23	= loadspacehelper.CreateShip("Keldon", pSet, "Keldon 23", "Keldon23Enter", 1)
	pKeldon24	= loadspacehelper.CreateShip("Keldon", pSet, "Keldon 24", "Keldon24Enter", 1)
	...
	pKeldon23.SetAI(E6M1_AI_Savoy1Keldon.CreateAI(pKeldon23, g_pKeldon6Targets, "Keldon23Enter"))
	pKeldon24.SetAI(E6M1_AI_Savoy1Keldon.CreateAI(pKeldon24, g_pKeldon7Targets, "Keldon24Enter"))
