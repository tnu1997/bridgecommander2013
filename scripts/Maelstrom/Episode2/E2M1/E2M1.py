...
#	Modified	9/15/2005 -	Bryan Cook (BC Super Mod V2.0)
###############################################################################
import App
...
def PreLoadAssets(pMission):
	...
	loadspacehelper.PreloadShip("NXSovereign", 1)
...
def CreateBeolShips():
	...
	pWarbird	= loadspacehelper.CreateShip("Warbird", pBeol4Set, "Warbird", "WarbirdStart")
	
	# Make Warbird's warp engines invincible so it can leave
	pWarp		= pWarbird.GetWarpEngineSubsystem()
	pWarp.SetInvincible(1)
