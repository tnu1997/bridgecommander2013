...
def CreateStartingObjects():
	...
	pSovereign	= loadspacehelper.CreateShip("NXSovereign", pTevron2Set, "Sov", "SovStart")
	pAmbassador	= loadspacehelper.CreateShip("Zhukov", pTevron2Set, "Ambassador", "ZhukovStart")
	pGalaxy1	= loadspacehelper.CreateShip("Galaxy", pTevron2Set, "Galaxy1", "GalaxyStart")
	pGalaxy1.ReplaceTexture("data/Models/SharedTextures/Galaxy/DauntlessID_glow.tga", "defaultID_glow")
	pGalaxy1.ReplaceTexture("data/Models/SharedTextures/Galaxy/DauntlessID_spec.tga", "defaultID_spec")
