...
def PreLoadAssets(pMission):
	...
	loadspacehelper.PreloadShip("NXSovereign2", 1)	
...
def CreateStartingObjects(pMission):
	...
	pSovereign		= loadspacehelper.CreateShip("NXSovereign2", pTevron2Set, "Sovereign", "SovStart")
...
def CreateWarbirds(pTGAction):
	...
	pWarbird1	= loadspacehelper.CreateShip("Warbird", pTevron2Set, "Warbird 1", "Warbird1Start")
	pWarbird2	= loadspacehelper.CreateShip("Warbird", pTevron2Set, "Warbird 2", "Warbird2Start")
	...
	# Make their warp engines invincible to allow them to leave
...
def CreateZhukov(pTGAction):
	...
	# Create the ship
	pSet	= App.g_kSetManager.GetSet("Tevron2")
	pZhukov	= loadspacehelper.CreateShip("Zhukov", pSet, "Zhukov", "ZhukovStart", 1)
