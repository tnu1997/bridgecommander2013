...
def LoadPlacements(sSetName):
	...
	# Position "Placement 6"
	kThis = App.Waypoint_Create("Placement 6", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-290.961029, 14.006432, 10.231918)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.872384, -0.488631, 0.013655)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.017617, -0.003511, 0.999839)
	...
	kThis.Update(0)
	kThis = None
	# End position "Placement 6"

	# Position "Placement 7"
	kThis = App.Waypoint_Create("Placement 7", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-344.446381, 5.780845, 9.777711)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.872384, -0.488631, 0.013655)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.017617, -0.003511, 0.999839)
