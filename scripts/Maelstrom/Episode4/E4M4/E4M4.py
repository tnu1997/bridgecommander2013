...
def PreLoadAssets(pMission):
	...
	loadspacehelper.PreloadShip("MatanKeldon2", 2)
...
def CreateShips():
	...
	pKeldon1 = loadspacehelper.CreateShip("MatanKeldon2", pVoltair1, "Custom Keldon 1", "Keldon1 Warp In")
	pKeldon2 = loadspacehelper.CreateShip("MatanKeldon2", pVoltair1, "Custom Keldon 2", "Keldon2 Warp In")
	...
	pPlayer = MissionLib.CreatePlayerShip("Sovereign", pBelaruz4, "player", "Player Start")
	...
	pIntrepid = loadspacehelper.CreateShip("LCIntrepid", pStarbase12, "USS Fitzgerald", "Circling Intrepid")
	...
	pMavjop = loadspacehelper.CreateShip("Kvort", pBelaruz4, "Mavjop", "Mavjop Start")

	# Set Federation Ship AI.
	import Maelstrom.Episode3.E3M1.E3M1NebulaAI
	pPrometheus.SetAI(Maelstrom.Episode3.E3M1.E3M1NebulaAI.CreateAI(pPrometheus))
	pIntrepid.SetAI(Maelstrom.Episode3.E3M1.E3M1NebulaAI.CreateAI(pIntrepid))
...
def SetAffiliations(pMission):
	...
	global g_pEnemies
	g_pEnemies = pMission.GetEnemyGroup()
	g_pEnemies.AddName("Custom Keldon 1")
	g_pEnemies.AddName("Custom Keldon 2")
	...
	g_pMavjopTargetGroup ["Custom Keldon 1"] = { "Priority" : 1.0 }
	g_pMavjopTargetGroup ["Custom Keldon 2"] = { "Priority" : 1.0 }
	...
	g_pMavjopTargetGroup2 ["Custom Keldon 1"] = { "Priority" : 0.0 }
	g_pMavjopTargetGroup2 ["Custom Keldon 2"] = { "Priority" : 0.0 }
...
def SetEnemyAI(pAction):
	pKeldon1 = MissionLib.GetShip("Custom Keldon 1")
	pKeldon2 = MissionLib.GetShip("Custom Keldon 2")
