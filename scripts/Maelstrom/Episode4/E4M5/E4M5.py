...
def PreLoadAssets(pMission):
	...
	loadspacehelper.PreloadShip("LCIntrepid", 1)
	loadspacehelper.PreloadShip("NebulaVar3", 1)
	loadspacehelper.PreloadShip("Prometheus", 1)
	loadspacehelper.PreloadShip("GalaxyDreadnought", 1)
	loadspacehelper.PreloadShip("Galaxy", 1)
	loadspacehelper.PreloadShip("Galor", 9)
	loadspacehelper.PreloadShip("Keldon", 3)
	loadspacehelper.PreloadShip("CardStation", 2)
	loadspacehelper.PreloadShip("CardHybrid", 4)
	loadspacehelper.PreloadShip("EnterpriseE", 1)
...
def CreateShips():
	...
	pPlayer.ReplaceTexture("data/Models/SharedTextures/Sovereign/SovereignID_glow.tga", "defaultID_glow")
	pPlayer.ReplaceTexture("data/Models/SharedTextures/Sovereign/SovereignID_specular.tga", "defaultID_specular")
	
	pStarbase = loadspacehelper.CreateShip("FedStarbase", pStarbase12, "Starbase 12", "Starbase12 Location")
	pPrometheus = loadspacehelper.CreateShip("Prometheus", pStarbase12, "USS Prometheus", "Nebula Start")
	pPrometheus.ReplaceTexture("data/Models/SharedTextures/Prometheus/PrometheusID_glow.tga", "1_glow")
	pPrometheus.ReplaceTexture("data/Models/SharedTextures/Prometheus/PrometheusID_spec.tga", "1_spec")

	pGalDread = loadspacehelper.CreateShip("GalaxyDreadnought", pStarbase12, "USS Pegasus", "GalaxyX Start")
	pGalDread.ReplaceTexture("data/Models/SharedTextures/GalaxyDreadnought/PegasusID_glow.tga", "defaultID_glow")
	pGalDread.ReplaceTexture("data/Models/SharedTextures/GalaxyDreadnought/PegasusID_spec.tga", "defaultID_spec")
	
	pIntrepid = loadspacehelper.CreateShip("LCIntrepid", pStarbase12, "USS Fitzgerald", "Intrepid Start")
	pIntrepid.ReplaceTexture("data/Models/SharedTextures/Intrepid/Fitzgerald04_glow.tga", "intrepid04_glow")
	pIntrepid.ReplaceTexture("data/Models/SharedTextures/Intrepid/Fitzgerald04_specular.tga", "intrepid04_specular")
	pIntrepid.SetAlertLevel(App.ShipClass.GREEN_ALERT)
	pIntrepid.SetStatic(TRUE)
	
	pNebula = loadspacehelper.CreateShip("NebulaVar3", pStarbase12, "USS Shogun", "Shogun Start")
	pNebula.ReplaceTexture("data/Models/SharedTextures/Nebula/ShogunID_glow.tga", "defaultID_glow")
	pNebula.ReplaceTexture("data/Models/SharedTextures/Nebula/ShogunID_spec.tga", "defaultID_spec")
	pNebula.SetAlertLevel(App.ShipClass.GREEN_ALERT)
	pNebula.SetStatic(TRUE)
	
	pMagellan = loadspacehelper.CreateShip("Galaxy", pStarbase12, "USS Magellan", "Galaxy Start")
	pMagellan.ReplaceTexture("data/Models/SharedTextures/Galaxy/MagellanID_glow.tga", "defaultID_glow")
	pMagellan.ReplaceTexture("data/Models/SharedTextures/Galaxy/MagellanID_spec.tga", "defaultID_spec")
	...
	pGalor3 = loadspacehelper.CreateShip("Galor", pChambana1, "Galor 3", "Galor3 Start")
	pGalor4 = loadspacehelper.CreateShip("Galor", pChambana1, "Galor 4", "Galor4 Start")
	pGalor5 = loadspacehelper.CreateShip("Galor", pChambana1, "Galor 5", "Galor5 Start")
	pGalor6 = loadspacehelper.CreateShip("Galor", pChambana1, "Galor 6", "Galor6 Start")
	pGalor7 = loadspacehelper.CreateShip("Galor", pChambana1, "Galor 7", "Galor7 Start")
	pGalor8 = loadspacehelper.CreateShip("Galor", pChambana1, "Galor 8", "Galor8 Start")
	pGalor9 = loadspacehelper.CreateShip("Galor", pChambana1, "Galor 9", "Galor9 Start")
	...
	pKeldon3 = loadspacehelper.CreateShip("Keldon", pChambana1, "Keldon 3", "Keldon3 Start")
	...
	# Set Shipyard's splash damage to 20% of player's hull per sec.	
	if pPlayer:
		pShipyard.SetSplashDamage(pPlayer.GetHull().GetMaxCondition() * 0.20, pShipyard.GetRadius()*2.5)

	# Make Cardassian warp engines invulnerable so they can warp out after station destruction.
	MissionLib.MakeEnginesInvincible(pGalor1)
	MissionLib.MakeEnginesInvincible(pGalor2)
	MissionLib.MakeEnginesInvincible(pGalor3)
	MissionLib.MakeEnginesInvincible(pGalor4)
	MissionLib.MakeEnginesInvincible(pGalor5)
	MissionLib.MakeEnginesInvincible(pGalor6)
	MissionLib.MakeEnginesInvincible(pGalor7)
	MissionLib.MakeEnginesInvincible(pGalor8)
	MissionLib.MakeEnginesInvincible(pGalor9)
	MissionLib.MakeEnginesInvincible(pKeldon1)
	MissionLib.MakeEnginesInvincible(pKeldon2)
	MissionLib.MakeEnginesInvincible(pKeldon3)

	import Maelstrom.Episode4.E4M5.E4M5NebulaAI

	if pPrometheus:
		pPrometheus.SetAI(Maelstrom.Episode4.E4M5.E4M5NebulaAI.CreateAI(pPrometheus))
	
	if pMagellan:
		pMagellan.SetAI(Maelstrom.Episode4.E4M5.E4M5NebulaAI.CreateAI(pMagellan))
	
	if pGalDread:
		import Maelstrom.Episode3.E3M4.PeregrineAI
		pGalDread.SetAI(Maelstrom.Episode3.E3M4.PeregrineAI.CreateAI(pGalDread))
...
def SetAffiliations(pMission):
	...
	g_pFriendlies.AddName("USS Shogun")
	g_pFriendlies.AddName("Starbase 12")
	g_pFriendlies.AddName("USS Prometheus")
	g_pFriendlies.AddName("USS Fitzgerald")
	g_pFriendlies.AddName("USS Magellan")
	g_pFriendlies.AddName("USS Pegasus")
	...
	g_pEnemies.AddName("Galor 7")
	g_pEnemies.AddName("Galor 8")
	g_pEnemies.AddName("Galor 9")
	g_pEnemies.AddName("Keldon 1")
	g_pEnemies.AddName("Keldon 2")
	g_pEnemies.AddName("Keldon 3")
...
def PicardWarpsIn(pAction):
	...
	pEnterprise = loadspacehelper.CreateShip("EnterpriseE", pStarbase12, "USS Enterprise", "Enterprise Start", TRUE)
	pEnterprise.ReplaceTexture("data/Models/SharedTextures/Sovereign/EnterpriseID_glow.tga", "defaultID_glow")
	pEnterprise.ReplaceTexture("data/Models/SharedTextures/Sovereign/EnterpriseID_specular.tga", "defaultID_specular")
	...
	MissionLib.SetupWeaponHitHandlers(["Galor 1", "Galor 2", "Galor 3", "Galor 4", "Galor 5", "Galor 6", "Galor 7", "Galor 8", "Galor 9", "Keldon 1", "Keldon 2", "Keldon 3"])
...
def SetEnemyShipAI(pAction):
	...
	pKeldon3 = MissionLib.GetShip("Keldon 3")
	assert pKeldon3
	if(pKeldon3):
		pKeldon3.SetAI(KeldonAttackAI.CreateAI(pKeldon3))
	...
	pGalor3 = MissionLib.GetShip("Galor 3")
	assert pGalor3
	if(pGalor3):
		pGalor3.SetAI(GalorAttackAI.CreateAI(pGalor3, "player"))

	pGalor4 = MissionLib.GetShip("Galor 4")
	assert pGalor4
	if(pGalor4):
		pGalor4.SetAI(GalorAttackAI.CreateAI(pGalor4, "USS Enterprise"))
	
	pGalor5 = MissionLib.GetShip("Galor 5")
	assert pGalor5
	if(pGalor5):
		pGalor5.SetAI(GalorAttackAI.CreateAI(pGalor5, "player"))

	pGalor6 = MissionLib.GetShip("Galor 6")
	assert pGalor6
	if(pGalor6):
		pGalor6.SetAI(GalorAttackAI.CreateAI(pGalor6, "USS Enterprise"))
	
	pGalor7 = MissionLib.GetShip("Galor 7")
	assert pGalor7
	if(pGalor7):
		pGalor7.SetAI(GalorAttackAI.CreateAI(pGalor7, "player"))

	pGalor8 = MissionLib.GetShip("Galor 8")
	assert pGalor8
	if(pGalor8):
		pGalor8.SetAI(GalorAttackAI.CreateAI(pGalor8, "USS Enterprise"))
	
	pGalor9 = MissionLib.GetShip("Galor 9")
	assert pGalor9
	if(pGalor9):
		pGalor9.SetAI(GalorAttackAI.CreateAI(pGalor9, "player"))
