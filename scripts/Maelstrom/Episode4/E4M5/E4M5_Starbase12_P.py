...
def LoadPlacements(sSetName):
	...
	# Position "GalaxyX Start"
	kThis = App.Waypoint_Create("GalaxyX Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(44.748604, -20.185289, 58.896635)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.583632, -0.263266, 0.768157)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.034457, 0.114532, 0.992822)
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetSpeed(25.000000)
	kThis.Update(0)
	kThis = None
	# End position "GalaxyX Start"
	
	# Position "Galaxy Start"
	kThis = App.Waypoint_Create("Galaxy Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetTranslateXYZ(-58.748604, -48.185289, 58.896635)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.583632, -0.263266, 47.50000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.034457, 0.114532, -0.992822)
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetSpeed(25.000000)
	...
	# Position "Intrepid Start"
	kThis = App.Waypoint_Create("Intrepid Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	...
	kThis.Update(0)
	kThis = None
	# End position "Intrepid Start"
	
	# Position "Shogun Start"
	kThis = App.Waypoint_Create("Shogun Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
