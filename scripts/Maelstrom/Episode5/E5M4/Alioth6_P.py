...
def LoadPlacements(sSetName):
	...
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-840.316162, 865.661987, -22.628872)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.975992, -0.217377, 0.013638)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.025479, 0.051761, 0.998334)
	...
	# Position "Keldon4 Start"
	kThis = App.Waypoint_Create("Keldon4 Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(459.379150, 1300.791016, 18.154602)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.466130, -0.884556, -0.016843)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.076896, 0.059472, 0.995264)
	...
	kThis.Update(0)
	kThis = None
	# End position "Keldon4 Start"

	# Position "Keldon5 Start"
	kThis = App.Waypoint_Create("Keldon5 Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-820.316162, 812.661987, -33.628872)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.975992, 0.217377, 0.013638)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.025479, 0.051761, 0.998334)
	...
	kThis.Update(0)
	kThis = None
	# End position "Keldon5 Start"

	# Position "Keldon6 Start"
	kThis = App.Waypoint_Create("Keldon6 Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(475.379150, 1260.791016, 42.154602)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.466130, -0.884556, 0.016843)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.076896, 0.059472, 0.995264)
	...
	kThis.Update(0)
	kThis = None
	# End position "Keldon6 Start"
	
	# Position "Keldon7 Start"
	kThis = App.Waypoint_Create("Keldon7 Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(495.316162, 1200.661987, 55.628872)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.975992, -0.217377, 0.013638)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.025479, 0.051761, 0.998334)
	...
	kThis.Update(0)
	kThis = None
	# End position "Keldon7 Start"

	# Position "Keldon8 Start"
	kThis = App.Waypoint_Create("Keldon8 Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(415.379150, 1400.791016, 98.154602)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.466130, -0.884556, -0.016843)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.076896, 0.059472, 0.995264)
	...
	kThis.Update(0)
	kThis = None
	# End position "Keldon8 Start"
	
	# Position "Keldon9 Start"
	kThis = App.Waypoint_Create("Keldon9 Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(444.379150, 1400.791016, 98.154602)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.466130, -0.884556, -0.016843)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.076896, 0.059472, 0.995264)
	...
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(756.205200, 1220.203369, 111.010582)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.988566, -0.088607, -0.122010)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.107588, -0.152460, 0.982436)
