...
def PreLoadAssets(pMission):
	...
	loadspacehelper.PreloadShip("Keldon", 12)
	loadspacehelper.PreloadShip("Galor", 11)
...
#	kDebugObj.Print("Creating first group of Cardies")
	...
	pMatanShip = loadspacehelper.CreateShip("MatanKeldon2", pSet, "Matan's Keldon", "Matan Start" )
	...
	pKeldon3 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon3", "Keldon3 Start" )
	pKeldon4 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon4", "Keldon4 Start" )
	pKeldon5 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon5", "Keldon5 Start" )
	pKeldon6 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon6", "Keldon6 Start" )
	pKeldon7 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon7", "Keldon7 Start" )
	pKeldon8 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon8", "Keldon8 Start" )
	pKeldon9 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon9", "Keldon9 Start" )
	...
	pGalor6 = loadspacehelper.CreateShip( "Galor", pSet, "Galor6", "Galor6 Start" )
	...
	import EnemyAI
	for pShip in [pKeldon1, pKeldon2, pKeldon3, pKeldon4, pKeldon5, pKeldon6, pKeldon7, pKeldon8, pKeldon9, pGalor1, pGalor2, pGalor3, pGalor4, pGalor5, pGalor6]:
