...
#	kDebugObj.Print ("Creating ships.\n")
	...
	pProm = loadspacehelper.CreateShip("Prometheus", pSet2, "USS Prometheus", "Prometheus")
	...
	pDef = loadspacehelper.CreateShip("Defiant", pSet2, "USS Defiant", "Defiant")
	
	pCoc = loadspacehelper.CreateShip("NebulaVar3", pSet2, "USS Shogun", "Cochrane")
	pCoc.ReplaceTexture("data/Models/SharedTextures/Nebula/ShogunID_glow.tga", "defaultID_glow")
	pCoc.ReplaceTexture("data/Models/SharedTextures/Nebula/ShogunID_spec.tga", "defaultID_spec")
	CreateGeronimo(pSet2)
	
	import IntrepidAI
	pCoc.SetAI(IntrepidAI.CreateAI(pCoc))
	
	import Maelstrom.Episode6.E6M3.E6M3_AI_Stay
	pDef.SetAI(Maelstrom.Episode6.E6M3.E6M3_AI_Stay.CreateAI(pDef))
	
	import Maelstrom.Episode3.E3M1.E3M1NebulaAI
	pProm.SetAI(Maelstrom.Episode3.E3M1.E3M1NebulaAI.CreateAI(pProm))
...
#	print("Creating Geronimo")
	...
	pShip = loadspacehelper.CreateShip( "Geronimo", pSet, "USS Geronimo", "Geronimo" )
	pShip.ReplaceTexture("data/Models/SharedTextures/Akira/GeronimoID_glow.tga", "akID_glow")
	pShip.ReplaceTexture("data/Models/SharedTextures/Akira/GeronimoID_specular.tga", "akID_specular")
	...
	pShip.DamageSystem(pShields, 6000)

	# Damage the Power Planet - 3000 pts of damage
	pShip.DamageSystem(pShip.GetPowerSubsystem(), 3000)
	# Damage the hull - 9000 pts of damage
	pShip.DamageSystem(pShip.GetHull(), 9000)
	# Damage the Impulse engines - 0 pts each
	pImpulse = pShip.GetImpulseEngineSubsystem()
	pShip.DamageSystem(pImpulse.GetChildSubsystem(0), 3000)
	pShip.DamageSystem(pImpulse.GetChildSubsystem(1), 3500)
...
#	kDebugObj.Print("Scanning the Geronimo, finding torps")
	...
	if (iNumQuantumsLeft != 100):
		...
		pSequence.AppendAction(pAction)
		pAction	= App.TGScriptAction_Create("MissionLib", "LoadTorpedoes", "Quantum", 100)
		pSequence.AppendAction(pAction)
