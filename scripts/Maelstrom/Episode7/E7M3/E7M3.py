...
#	DebugPrint ("Creating ships.\n")
	...
	pEnemyTargets.AddName("Custom Keldon")
...
def CardassianAttack(pObject, pEvent):
	...
	if iAttackWave == 1:
		...
		if bArt3Defenders:
			pShip = App.ShipClass_GetObject(pSet, "Custom Keldon")
			if pShip:
				bFelixWarn = 1
				FollowPlayer("Custom Keldon")
...
#		DebugPrint ("Disabling Geronimo's Warp Engines and making them invincible.")
		...
		if (pWarp):
			MissionLib.SetConditionPercentage(pWarp, pWarp.GetDisabledPercentage() - 0.1)
...
def CreateSensorDefenders(pSet, iInt = 0):
	...
	if (pSet.GetName() == "Artrus3"):
		...
		pKeldon1 = loadspacehelper.CreateShip( "MatanKeldon2", pSet, "Custom Keldon", "Enemy1 Start" )
		...
		if iInt == 1:
			FollowPlayer("Custom Keldon", "Galor1")
...
#	DebugPrint("Setting Artrus3 AI")
	...
	pKeldon1 = App.ShipClass_GetObject(pSet, "Custom Keldon")
...
#				DebugPrint("Last enemy follower destroyed")
		...
		if(sShipName == "Custom Keldon") or (sShipName == "Galor1"):
