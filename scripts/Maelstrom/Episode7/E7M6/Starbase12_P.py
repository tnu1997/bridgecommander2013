...
def LoadPlacements(sSetName):
	...
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-59.925085, -540.485840, 32.094382)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.115372, 0.993322, -0.000063)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000701, 0.000145, 1.000000)
	...
	# Position "Prometheus Start"
	kThis = App.Waypoint_Create("Prometheus Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-59.925085, -540.485840, -25.094382)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.115372, 0.993322, -0.000063)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000701, 0.000145, 1.000000)
