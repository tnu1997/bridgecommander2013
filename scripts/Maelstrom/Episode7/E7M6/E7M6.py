...
#	Modified:	9/16/05 -	Bryan Cook (BC Super Mod V2.0)
###############################################################################
import App
...
g_iNumAttackers		= 0
g_iMaxTotalShips	= 61
g_iMaxEnemiesInSet	= 18
g_iGroup1Remaining	= 15
...
def PreLoadAssets(pMission):
	...
	loadspacehelper.PreloadShip("Galor", 26)
	loadspacehelper.PreloadShip("Keldon", 24)
...
#	DebugPrint("Creating characters and their sets")
	...
	MissionLib.SetMaxTorpsForPlayer("Quantum", 100)
...
def CreateShips(pMission):
	...
	pPlayer = MissionLib.CreatePlayerShip("Sovereign", pSB12Set, "player", "Player Start")
	...
	pDefiant  = loadspacehelper.CreateShip("Defiant", pSB12Set, "USS Defiant", "Defiant Start")
	pProm     = loadspacehelper.CreateShip("Prometheus", pSB12Set, "USS Prometheus", "Prometheus Start")
	pProm.ReplaceTexture("data/Models/SharedTextures/Prometheus/PrometheusID_glow.tga", "1_glow")
	pProm.ReplaceTexture("data/Models/SharedTextures/Prometheus/PrometheusID_spec.tga", "1_spec")

	# Start the friendly fire watches
	MissionLib.SetupFriendlyFire()

	# Create allied ships.
	pKlingon1 = loadspacehelper.CreateShip("Neghvar", pSB12Set, "HoH'egh", "Klingon 1 Start")
	...
	loadspacehelper.CreateShip("Keldon", pAlioth6Set, "Keldon8", "Keldon 8888 Start")
	loadspacehelper.CreateShip("Keldon", pAlioth6Set, "Keldon9", "Keldon 9999 Start")
	...
	pFriendlies.AddName("USS Defiant")
	...
	pEnemies.AddName("Galor7")
	pEnemies.AddName("Galor8")
	pEnemies.AddName("Galor9")
	pEnemies.AddName("Galor10")
	pEnemies.AddName("Galor11")
	...
	pEnemies.AddName("Keldon8")
	pEnemies.AddName("Keldon9")
	...
	pAlioth8Enemies.AddName("Galor7")
	pAlioth8Enemies.AddName("Galor8")
	pAlioth8Enemies.AddName("Galor9")
	pAlioth8Enemies.AddName("Galor10")
	pAlioth8Enemies.AddName("Galor11")
	pAlioth8Enemies.AddName("Keldon2")
	pAlioth8Enemies.AddName("Keldon3")
	pAlioth8Enemies.AddName("Keldon4")
	pAlioth8Enemies.AddName("Keldon5")
	pAlioth8Enemies.AddName("Keldon6")
	pAlioth8Enemies.AddName("Keldon7")
	pHostiles.AddName("Galor5")
	pHostiles.AddName("Galor6")
	pHostiles.AddName("Keldon1")
	pHostiles.AddName("Keldon8")
	pHostiles.AddName("Keldon9")
	pHostiles.AddName("Galor1")
	pHostiles.AddName("Galor2")
	pHostiles.AddName("Galor3")
	pHostiles.AddName("Galor4")
	pHostiles.AddName("Galor7")
	pHostiles.AddName("Galor8")
	pHostiles.AddName("Galor9")
	pHostiles.AddName("Galor10")
	pHostiles.AddName("Galor11")
	pHostiles.AddName("Keldon2")
	pHostiles.AddName("Keldon3")
	pHostiles.AddName("Keldon4")
	pHostiles.AddName("Keldon5")
	pHostiles.AddName("Keldon6")
	pHostiles.AddName("Keldon7")
	pGroup1ObjGroup.AddName("Galor1")
	pGroup1ObjGroup.AddName("Galor2")
	pGroup1ObjGroup.AddName("Galor3")
	pGroup1ObjGroup.AddName("Galor4")
	pGroup1ObjGroup.AddName("Galor7")
	pGroup1ObjGroup.AddName("Galor8")
	pGroup1ObjGroup.AddName("Galor9")
	pGroup1ObjGroup.AddName("Galor10")
	pGroup1ObjGroup.AddName("Galor11")
	pGroup1ObjGroup.AddName("Keldon2")
	pGroup1ObjGroup.AddName("Keldon3")
	pGroup1ObjGroup.AddName("Keldon4")
	pGroup1ObjGroup.AddName("Keldon5")
	pGroup1ObjGroup.AddName("Keldon6")
	pGroup1ObjGroup.AddName("Keldon7")
										
	# Set their AI.
	SetAI(None, pKlingon1, AlliedAI)
	SetAI(None, pRomulan1, AlliedAI)
	SetAI(None, pProm, AlliedAI)
	SetAI(None, pDefiant, AlliedAI)
...
#		DebugPrint("Geronimo is alive and rescued, so have her join the player")
		...
		pGeronimo.ReplaceTexture("data/Models/SharedTextures/Akira/GeronimoID_glow.tga", "akID_glow")
		pGeronimo.ReplaceTexture("data/Models/SharedTextures/Akira/GeronimoID_specular.tga", "akID_specular")
		# Give Geronimo AI
	...
	MissionLib.AddCommandableShip("USS Defiant")
...
#	DebugPrint("Handling Hail")
	...
	elif (sTarget == "USS Prometheus"):
		pData = App.g_kLocalizationManager.Load("data/TGL/Maelstrom/Episode 6/Episode6.tgl")
		pAction = App.CharacterAction_Create(g_pKiska, App.CharacterAction.AT_SAY_LINE, "E6HailAnyone3", None, 0, pData)
		App.g_kLocalizationManager.Unload(pData)
	
	elif (sTarget == "USS Defiant"):
		pData = App.g_kLocalizationManager.Load("data/TGL/Maelstrom/Episode 6/Episode6.tgl")
		pAction = App.CharacterAction_Create(g_pKiska, App.CharacterAction.AT_SAY_LINE, "E6HailAnyone1", None, 0, pData)
		App.g_kLocalizationManager.Unload(pData)
...
def EnterpriseWarpIn(TGObject, pEvent):
	...
	if (pSet.GetName() == "Alioth6"):
		...
		pEnterprise = loadspacehelper.CreateShip("EnterpriseE", pSet, "USS Enterprise", "Enterprise Start")
...
def Alioth8Arrive():
	...
	pAction = App.TGScriptAction_Create(__name__, "WarpInGalor", 7)
	pSequence.AddAction(pAction, pAction1, 4)
	pAction = App.TGScriptAction_Create(__name__, "WarpInGalor", 8)
	pSequence.AddAction(pAction, pAction1, 5)
	pAction = App.TGScriptAction_Create(__name__, "WarpInGalor", 9)
	pSequence.AddAction(pAction, pAction1, 6)
	pAction = App.TGScriptAction_Create(__name__, "WarpInGalor", 10)
	pSequence.AddAction(pAction, pAction1, 7)
	pAction = App.TGScriptAction_Create(__name__, "WarpInGalor", 11)
	pSequence.AddAction(pAction, pAction1, 8)
	pAction = App.TGScriptAction_Create(__name__, "WarpInKeldon", 2)
	pSequence.AddAction(pAction, pAction1, 9)
	pAction = App.TGScriptAction_Create(__name__, "WarpInKeldon", 3)
	pSequence.AddAction(pAction, pAction1, 10)
	pAction = App.TGScriptAction_Create(__name__, "WarpInKeldon", 4)
	pSequence.AddAction(pAction, pAction1, 11)
	pAction = App.TGScriptAction_Create(__name__, "WarpInKeldon", 5)
	pSequence.AddAction(pAction, pAction1, 12)
	pAction = App.TGScriptAction_Create(__name__, "WarpInKeldon", 6)
	pSequence.AddAction(pAction, pAction1, 13)
	pAction = App.TGScriptAction_Create(__name__, "WarpInKeldon", 7)
	pSequence.AddAction(pAction, pAction1, 14)
...
def WarpInGalor(pAction, iGalor):
	if (((iGalor > 0) and (iGalor < 5)) or ((iGalor > 6) and (iGalor < 12))):
...
def WarpInKeldon(pAction, iKeldon):
	if ((iKeldon > 1) and (iKeldon < 8)):
		pSet = App.g_kSetManager.GetSet("Alioth8")
		pKeldon = loadspacehelper.CreateShip("Keldon", pSet, "Keldon" + str(iKeldon), "Attacker " + str(iKeldon + 10) + " Start", 1)
		pKeldon.SetAI(EnemyFollowAI.CreateAI(pKeldon))
