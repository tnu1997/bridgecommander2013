...
def LoadPlacements(sSetName):
	...
	# Position "Keldon 8888 Start"
	kThis = App.Waypoint_Create("Keldon 8888 Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(2.872293, 320.675201, 8.159772)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.189009, 0.974571, 0.120362)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.037478, 0.115323, 0.992621)
	...
	kThis.Update(0)
	kThis = None
	# End position "Keldon 8888 Start"
	
	# Position "Keldon 9999 Start"
	kThis = App.Waypoint_Create("Keldon 9999 Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-14.872293, 270.675201, 15.159772)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.189009, 0.974571, 0.120362)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.037478, 0.115323, 0.992621)
	...
	kThis.Update(0)
	kThis = None
	# End position "Keldon 9999 Start"
