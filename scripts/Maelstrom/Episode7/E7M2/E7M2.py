...
#	Modified:	6/13/06 -	Bryan Cook (BC Super Mod V3.0)
###############################################################################
import App
...
#		DebugPrint("Ship \"%s\" was destroyed" % pShip.GetName())
		...
		if (pShip.GetName()[:len("Galor")] == "Galor") or (pShip.GetName()[:len("Keldon")] == "Keldon"):
			...
			if (iEnemiesDestroyed == 21):
				iEnemiesDestroyed = 22
...
#	DebugPrint("Creating first group of Cardies")
	...
	pKeldon2 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon2", "Enemy11 Start", 1 )
	pKeldon3 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon3", "Enemy12 Start", 1 )
	pKeldon4 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon4", "Enemy22 Start", 1 )
	pKeldon5 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon5", "Enemy32 Start", 1 )
	pKeldon6 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon6", "Enemy42 Start", 1 )
	...
	pGalor3 = loadspacehelper.CreateShip( "Galor", pSet, "Galor3", "Enemy13 Start", 1 )
	pGalor4 = loadspacehelper.CreateShip( "Galor", pSet, "Galor4", "Enemy23 Start", 1 )
	pGalor5 = loadspacehelper.CreateShip( "Galor", pSet, "Galor5", "Enemy33 Start", 1 )
	pGalor6 = loadspacehelper.CreateShip( "Galor", pSet, "Galor6", "Enemy43 Start", 1 )
	...
	pKeldon2.SetAI(EnemyAI.CreateAI(pKeldon2, "Enemy2 Way1"))
	pKeldon3.SetAI(EnemyAI.CreateAI(pKeldon3, "Enemy3 Way1"))
	pKeldon4.SetAI(EnemyAI.CreateAI(pKeldon4, "Enemy7 Way1"))
	pKeldon5.SetAI(EnemyAI.CreateAI(pKeldon5, "Enemy8 Way1"))
	pKeldon6.SetAI(EnemyAI.CreateAI(pKeldon6, "Enemy9 Way1"))
	pGalor1.SetAI(EnemyAI.CreateAI(pGalor1, "Enemy4 Way1"))
	pGalor2.SetAI(EnemyAI.CreateAI(pGalor2, "Enemy5 Way1"))
	pGalor3.SetAI(EnemyAI.CreateAI(pGalor3, "Enemy6 Way1"))
	pGalor4.SetAI(EnemyAI.CreateAI(pGalor4, "Enemy10 Way1"))
	pGalor5.SetAI(EnemyAI.CreateAI(pGalor5, "Enemy11 Way1"))
	pGalor6.SetAI(EnemyAI.CreateAI(pGalor6, "Enemy12 Way1"))
...
#	DebugPrint("Creating second group of Cardies")
	...
	pKeldon7 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon7", "Enemy1 Way1", 1 )
	pKeldon8 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon8", "Enemy2 Way1", 1 )
	pKeldon9 = loadspacehelper.CreateShip( "Keldon", pSet, "Keldon9", "Enemy3 Way1", 1 )
	pGalor7 = loadspacehelper.CreateShip( "Galor", pSet, "Galor7", "Enemy4 Way1", 1 )
	pGalor8 = loadspacehelper.CreateShip( "Galor", pSet, "Galor8", "Enemy5 Way1", 1 )
	pGalor9 = loadspacehelper.CreateShip( "Galor", pSet, "Galor9", "Enemy6 Way1", 1 )
	pGalor10 = loadspacehelper.CreateShip( "Galor", pSet, "Galor10", "Enemy10 Way1", 1 )
	pGalor11 = loadspacehelper.CreateShip( "Galor", pSet, "Galor11", "Enemy11 Way1", 1 )
	pGalor12 = loadspacehelper.CreateShip( "Galor", pSet, "Galor12", "Enemy12 Way1", 1 )

	pKeldon7.SetAI(EnemyAI.CreateAI(pKeldon7, "Enemy1 Way1"))
	pKeldon8.SetAI(EnemyAI.CreateAI(pKeldon8, "Enemy2 Way1"))
	pKeldon9.SetAI(EnemyAI.CreateAI(pKeldon9, "Enemy3 Way1"))
	pGalor7.SetAI(EnemyAI.CreateAI(pGalor7, "Enemy4 Way1"))
	pGalor8.SetAI(EnemyAI.CreateAI(pGalor8, "Enemy5 Way1"))
	pGalor9.SetAI(EnemyAI.CreateAI(pGalor9, "Enemy6 Way1"))
	pGalor10.SetAI(EnemyAI.CreateAI(pGalor10, "Enemy10 Way1"))
	pGalor11.SetAI(EnemyAI.CreateAI(pGalor11, "Enemy11 Way1"))
	pGalor12.SetAI(EnemyAI.CreateAI(pGalor12, "Enemy12 Way1"))
	
	pTGL	= App.g_kLocalizationManager.Load("data/TGL/Maelstrom/Episode 6/E6M1.TGL")
	pAction = App.CharacterAction_Create(g_pFelix, App.CharacterAction.AT_SAY_LINE, "E6M1ArtrusSecondWave1a", "Captain", 1, pTGL)
	App.g_kLocalizationManager.Unload(pTGL)
	pAction.Play()
