...
#	print "Creating static objects for Vesuvi5 region"
	...
	pMoon = App.Planet_Create(50.0, "data/models/environment/NewPlanets/moon.nif")
	...
	if (pGekiStation != None):
		...
		# Damage it's hull
		pGekiStation.DamageSystem(pGekiStation.GetHull(), pGekiStation.GetHull().GetMaxCondition() * 0.65)
