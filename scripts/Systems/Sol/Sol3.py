...
def LoadPlacements(sSetName):
	...
	# Position "Planet1" - 384,500 km average average distance
	kThis = App.Waypoint_Create("Moon", sSetName, None)
	kThis.SetStatic(1)
	coord = placer.SetOnOrbit(21971.43)
	kThis.SetTranslateXYZ(coord[0], coord[1], coord[2])
	kForward = App.TGPoint3()
	...
	kThis = App.Waypoint_Create("Starfleet Command", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetNavPoint(1)
	coord = placer.SetOnOrbit(2197.143)
	kThis.SetTranslateXYZ(coord[0], coord[1], coord[2])
