...
def Initialize(pMission):
	...
	SetupExpansionPacks()	#Apollo Change 1 of 2
...
#	SetupExpansionPacks()
#
#	This is called from Initialize to setup up the packs that will be
#	overwritten with the Foundation.OverrideDef. I you plan to make
#	a modification
#
#	Apollo Change 2 of 2
#
#	Args:	none
#
#	Return:	none
...
def Expansion002(pGame):
	return (0)

def Expansion003(pGame):
	return (0)

def Expansion004(pGame):
	return (0)

def Expansion005(pGame):
	return (0)

def Expansion006(pGame):
	return (0)

def Expansion007(pGame):
	return (0)
	
def Expansion008(pGame):
	return (0)

def Expansion009(pGame):
	return (0)

def Expansion010(pGame):
	return (0)

def Expansion011(pGame):
	return (0)

def Expansion012(pGame):
	return (0)

def Expansion013(pGame):
	return (0)

def Expansion014(pGame):
	return (0)

def Expansion015(pGame):
	return (0)

def Expansion016(pGame):
	return (0)

def Expansion017(pGame):
	return (0)

def Expansion018(pGame):
	return (0)

def Expansion019(pGame):
	return (0)

def Expansion020(pGame):
	return (0)
...
def GenerateShips():
	...
	for kShipData in kShipList:
		...
		vForward.Scale(pPlayer.GetRadius() + pShip.GetRadius() + 200.0)
		...
		# And orient it so it's facing us.
