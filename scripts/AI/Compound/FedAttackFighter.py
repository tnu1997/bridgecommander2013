...
def CreateAI(pShip, *lpTargets, **dKeywords):
    ...
    pBuilderAI.AddAIBlock('CautiousAssault', 'BuilderCreate18')
    pBuilderAI.AddDependency('CautiousAssault', 'ICOMoveIn_2')
    pBuilderAI.AddDependencyObject('CautiousAssault', 'dKeywords', dKeywords)
    pBuilderAI.AddAIBlock('SweepPhasers', 'BuilderCreate19')
    ...
    pBuilderAI.AddAIBlock('PriorityList_2', 'BuilderCreate22')
    pBuilderAI.AddDependency('PriorityList_2', 'TooClose')
    pBuilderAI.AddDependency('PriorityList_2', 'TooFar')
    pBuilderAI.AddAIBlock('FireAll', 'BuilderCreate23')
    ...
    pBuilderAI.AddAIBlock('CloseRange', 'BuilderCreate24')
    ...
    pBuilderAI.AddAIBlock('TorpRun', 'BuilderCreate25')
    pBuilderAI.AddDependencyObject('TorpRun', 'sInitialTarget', sInitialTarget)
    pBuilderAI.AddAIBlock('TorpsReady_FwdShieldStrong', 'BuilderCreate26')
    pBuilderAI.AddDependency('TorpsReady_FwdShieldStrong', 'TorpRun')
    pBuilderAI.AddAIBlock('MoveIn_2', 'BuilderCreate27')
    pBuilderAI.AddDependencyObject('MoveIn_2', 'sInitialTarget', sInitialTarget)
    pBuilderAI.AddAIBlock('MidRangePriorities', 'BuilderCreate28')
    ...
    pBuilderAI.AddAIBlock('FireAll2', 'BuilderCreate29')
    ...
    pBuilderAI.AddAIBlock('MidRange', 'BuilderCreate30')
    ...
    pBuilderAI.AddAIBlock('SelectTarget', 'BuilderCreate35')
    ...
    pBuilderAI.AddAIBlock('FollowTargetThroughWarp', 'BuilderCreate36')
    ...
    pBuilderAI.AddAIBlock('FollowThroughWarpFlag', 'BuilderCreate37')
    ...
    pBuilderAI.AddAIBlock('FleeAttackOrFollow', 'BuilderCreate38')
    ...
    pBuilderAI.AddAIBlock('PowerManagement', 'BuilderCreate39')
    ...
    pBuilderAI.AddAIBlock('AlertLevel', 'BuilderCreate40')
    pBuilderAI.AddDependency('AlertLevel', 'PowerManagement')
    pBuilderAI.AddAIBlock('AvoidObstaclesUpdated', 'BuilderCreate41')
...
def BuilderCreate4(pShip, pRearTorpRun, dKeywords):
    ...
    def EvalFunc(bTorpsReady, bRearShieldsLow, bUsingTorps):
...
def BuilderCreate7(pShip, sInitialTarget, dKeywords):
    ...
    pICOMoveOut = AI.Compound.Parts.ICOMove.CreateAI(pShip, sInitialTarget, dKeywords, -0.8)
    return pICOMoveOut
...
def BuilderCreate17(pShip, sInitialTarget, dKeywords):
    ...
    import AI.Compound.Parts.ICOMove
    pICOMoveIn_2 = AI.Compound.Parts.ICOMove.CreateAI(pShip, sInitialTarget, dKeywords, 0.0)
    return pICOMoveIn_2


def BuilderCreate18(pShip, pICOMoveIn_2, dKeywords):
    ...
    pCautiousAssault = App.ConditionalAI_Create(pShip, 'CautiousAssault')
    pCautiousAssault.SetInterruptable(1)
    pCautiousAssault.SetContainedAI(pICOMoveIn_2)
    pCautiousAssault.AddCondition(pFrontLow)
    pCautiousAssault.SetEvaluationFunction(EvalFunc)
    return pCautiousAssault


def BuilderCreate19(pShip, sInitialTarget, dKeywords):
...
def BuilderCreate20(pShip, pPriorityList_3, pUsingPulseWeapons, pCautiousAssault, pSweepPhasers):
    ...
    pTooFarPriorities.AddAI(pCautiousAssault, 3)
    pTooFarPriorities.AddAI(pSweepPhasers, 4)
    return pTooFarPriorities


def BuilderCreate21(pShip, pTooFarPriorities, fTooCloseRange, sInitialTarget):
...
def BuilderCreate22(pShip, pTooClose, pTooFar):
...
def BuilderCreate23(pShip, pPriorityList_2, sInitialTarget, dKeywords):
...
def BuilderCreate24(pShip, pFireAll, fCloseRange, sInitialTarget):
...
def BuilderCreate26(pShip, pTorpRun):
...
def BuilderCreate27(pShip, sInitialTarget):
...
def BuilderCreate28(pShip, pTorpsReady_FwdShieldStrong, pMoveIn_2):
...
def BuilderCreate29(pShip, pMidRangePriorities, sInitialTarget, dKeywords):
...
def BuilderCreate30(pShip, pFireAll2, fMidRange, sInitialTarget):
...
def BuilderCreate31(pShip, sInitialTarget):
...
def BuilderCreate32(pShip, pMoveIn, sInitialTarget):
...
def BuilderCreate33(pShip, sInitialTarget):
...
def BuilderCreate34(pShip, pCloseRange, pMidRange, pLongRange, pInterceptTarget):
...
def BuilderCreate35(pShip, pPriorityList, pAllTargetsGroup, sInitialTarget):
...
def BuilderCreate36(pShip, pSelectTarget, sInitialTarget, dKeywords):
...
def BuilderCreate37(pShip, pFollowTargetThroughWarp, dKeywords):
...
def BuilderCreate38(pShip, pCheckWarpBeforeDeath, pNoSensorsEvasive, pSelectTarget, pFollowThroughWarpFlag):
...
def BuilderCreate39(pShip, pFleeAttackOrFollow, dKeywords):
...
def BuilderCreate40(pShip, pPowerManagement):
...
def BuilderCreate41(pShip, pAlertLevel):
