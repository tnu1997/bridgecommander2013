...
def CreateAI(pShip, sDefendee):
        ...
        pAttack = AI.Compound.BasicAttack.CreateAI(pShip, pAttackGroup, MaxFiringRange = 295.0, AggressivePulseWeapons = 1, UseCloaking = 1)
        ...
        ## Conditions:
        #### Condition Attacked
        pAttacked = App.ConditionScript_Create("Conditions.ConditionAttacked", "ConditionAttacked", sDefendee, 0.000001, 0.000001, 0.0)
        ## Evaluation function:
