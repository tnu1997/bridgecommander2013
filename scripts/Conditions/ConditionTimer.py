...
class ConditionTimer:
	...
	def TimerTriggered(self, pEvent):
		...
		debug(__name__ + ", TimerTriggered " + str(self.pCodeCondition))
		debug(__name__ + ", TimerTriggered " + str(self.pCodeCondition.IsActive()))
		debug(__name__ + ", TimerTriggered " + str(self.pCodeCondition.GetStatus()))
		debug(__name__ + ", TimerTriggered " + str(self.pCodeCondition.GetObjID()))
		pObject = App.ConditionScript_Cast(App.TGObject_GetTGObjectPtr(self.pCodeCondition.GetObjID()))
		debug(__name__ + ", TimerTriggered " + str(pObject))
