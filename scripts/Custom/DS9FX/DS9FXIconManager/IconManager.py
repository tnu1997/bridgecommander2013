...
# After being poked by Cackad to make a new GUI, I finally agreed. This code loads in the icons which we can use in the GUI Window
...
# Vars
# Icon name list, it will save us a lot of space
...
def LoadDS9FX_Icons(pDS9FXIconGroup = None):
        ...
        debug(__name__ + ", LoadDS9FX_Icons")
...
def DS9FXIcons(pDS9FXIconGroup = None):
        ...
        # Weird BC behaviour so better reset the sLocation like this
	sLocation = None	
        sLocation = 1
