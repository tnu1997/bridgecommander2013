...
# by USS Sovereign. Mission 1 from the DS9FX Border Skirmish Campaign.
...
def CreateEntries(pObject, pEvent):
        ...
        pIconWindow = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize", App.TGString("Mission: Patrol Duty"), 0.0, 0.0, None, 1, 0.30, 0.30, App.g_kMainMenuBorderMainColor)
...
def MissionPlacement(pObject, pEvent):
	...
	pMission = pEpisode.GetCurrentMission()
        ...
        if (pSet.GetName() == "GammaQuadrant1"):
            ...
            # Create our targeted objective ship, mask it of course with a name: Bugship 4. And of course place it far, far away from the actual inital fight. That is of course if you 1st turned on the 3 bugships in the Gamma Map.         
            Bug1 = "Bugship 4"
	    import Custom.DS9FX.DS9FXShips
            ...
            # Start up a Mission Handler which will tell the user that something odd has been discovered
