...
# by USS Sovereign. Mission 3 from the DS9FX Border Skirmish Campaign.
...
def CreateEntries(pObject, pEvent):
        ...
        pIconWindow = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize", App.TGString("Mission: A Time To Fight"), 0.0, 0.0, None, 1, 0.30, 0.30, App.g_kMainMenuBorderMainColor)
...
def MissionInitiate(pObject, pEvent):
	...
	pPlayerShipType = GetShipType(pPlayer)
        ...
        # Spawn Romulan, Fed & Klingon Support Ships
        SpawnSupportShips()
...
def MissionStart(pObject, pEvent):
	...
	pMission = pEpisode.GetCurrentMission()
        ...
        if (pSet.GetName() == "GammaQuadrant1"):
            ...
            Bug1 = "Bugship 4"
	    import Custom.DS9FX.DS9FXShips
            pBug1 = loadspacehelper.CreateShip(Custom.DS9FX.DS9FXShips.DS9FXDominionFighter, GammaSet, Bug1, "Bugship 4 Mission Location")
            ...
            # 4th ship    
            Bug4 = "Bugship 7"
            pBug4 = loadspacehelper.CreateShip(Custom.DS9FX.DS9FXShips.DS9FXDominionFighter, GammaSet, Bug4, "Location 4")
            ...
            # 5th ship    
            Bug5 = "Battlecruiser"
            pBug5 = loadspacehelper.CreateShip(Custom.DS9FX.DS9FXShips.DS9FXDominionBC, GammaSet, Bug5, "Location 5")
            ...
            pBug6 = loadspacehelper.CreateShip(Custom.DS9FX.DS9FXShips.DS9FXMissionStation, GammaSet, Bug6, "Location 3")
...
# Let's restore the user to the ship he used in mission 2
def SetupPlayer():
            debug(__name__ + ", SetupPlayer")
            File = __import__("Save.mission3")
            pShip = File.Ship
...
# Spawning mentioned support ships in the Briefing
def SpawnSupportShips():
        ...
        # 2 fed ships, 1 is named USS Croatia :P Artistic Freedom
        import Custom.DS9FX.DS9FXShips
        loadspacehelper.CreateShip(Custom.DS9FX.DS9FXShips.DS9FXGalaxy, pSet, "USS Croatia", "WarpIn 1")
        ...
        # USS Molotov
        loadspacehelper.CreateShip(Custom.DS9FX.DS9FXShips.DS9FXCentaur, pSet, "USS Molotov", "WarpIn 2")
        ...
        # Vorcha class
        loadspacehelper.CreateShip(Custom.DS9FX.DS9FXShips.DS9FXVorcha, pSet, "IKV Qo'Joh", "WarpIn 3")
        ...
        # Romulan Warbird
        loadspacehelper.CreateShip(Custom.DS9FX.DS9FXShips.DS9FXWarbird, pSet, "RIS Ptarmigan", "WarpIn 4")
...
def BackToDS9(pObject, pEvent):
	...
	pMission = pEpisode.GetCurrentMission()
        ...
        if (pSet.GetName() == "DeepSpace91"):
            ...
            MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".RemoveFriendlyShips", App.g_kUtopiaModule.GetGameTime() + 35, 0, 0)
...
# Remove friendly ships
def RemoveFriendlyShips(pObject, pEvent):
    
        debug(__name__ + ", RemoveFriendlyShips")
