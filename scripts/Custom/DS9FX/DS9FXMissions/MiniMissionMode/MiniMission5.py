...
# by USS Sovereign, Mission: Valiant
...
def CreateEntries(pObject, pEvent):
        ...
        pIconWindow = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize", App.TGString("Mission: Valiant"), 0.0, 0.0, None, 1, 0.30, 0.30, App.g_kMainMenuBorderMainColor)
...
def MissionSetup():
            ...
            import Custom.DS9FX.DS9FXShips
            loadspacehelper.CreateShip(Custom.DS9FX.DS9FXShips.DS9FXDominionBC, pSet, "Dreadnought", "DomDread Pos")
