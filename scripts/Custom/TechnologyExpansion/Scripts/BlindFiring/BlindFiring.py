...
def BFCreateMenu(pSpecialMenu):
	...
	pSpecialMenu.AddPythonFuncHandlerForInstance(BLIND_FIRE_R, __name__ + ".BlindFireR")
	pSpecialMenu.AddPythonFuncHandlerForInstance(BLIND_FIRE_Z, __name__ + ".BlindFireZ")
	pSpecialMenu.AddPythonFuncHandlerForInstance(BLIND_FIRE_D, __name__ + ".BlindFireD")
	pSpecialMenu.AddPythonFuncHandlerForInstance(BLIND_FIRE_V, __name__ + ".BlindFireV")
	pSpecialMenu.AddPythonFuncHandlerForInstance(BLIND_FIRE_A, __name__ + ".BlindFireA")
	pSpecialMenu.AddPythonFuncHandlerForInstance(BLIND_FIRE_F, __name__ + ".BlindFireF")
	pSpecialMenu.AddPythonFuncHandlerForInstance(BLIND_FIRE_P, __name__ + ".BlindFireP")
	pSpecialMenu.AddPythonFuncHandlerForInstance(BLIND_FIRE_S, __name__ + ".BlindFireS")
	pSpecialMenu.AddPythonFuncHandlerForInstance(BLIND_FIRE_M, __name__ + ".BlindFireM")
	pSpecialMenu.AddPythonFuncHandlerForInstance(BLIND_FIRE_FIXED, __name__ + ".BlindFireFixed")
	pSpecialMenu.AddPythonFuncHandlerForInstance(CEASE_FIRE, __name__ + ".CeaseFire")
