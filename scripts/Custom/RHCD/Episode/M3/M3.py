...
def PreLoadAssets(pMission):
	...
	loadspacehelper.PreloadShip("D7", 9)
...
def Voltair2Cutscene():
	...
	# would be unfair.
	pD71 = loadspacehelper.CreateShip("D7", pVoltair2Set, "D7 1", "D7 1 Start", 1)
	pD72 = loadspacehelper.CreateShip("D7", pVoltair2Set, "D7 2", "D7 2 Start", 1)
	pD73 = loadspacehelper.CreateShip("D7", pVoltair2Set, "D7 3", "D7 3 Start", 1)
...
def CreateSecondWave(pObject, pEvent):
	...
	# Create ships
	pD74 = loadspacehelper.CreateShip("D7", pVoltair2Set, "D7 4", "D7 4 Start", 1)
	pD75 = loadspacehelper.CreateShip("D7", pVoltair2Set, "D7 5", "D7 5 Start", 1)
	pD76 = loadspacehelper.CreateShip("D7", pVoltair2Set, "D7 6", "D7 6 Start", 1)	
...
def CreateThirdWave(pObject, pEvent):
	...
	# Create ships
	pD77 = loadspacehelper.CreateShip("D7", pVoltair2Set, "D7 7", "D7 7 Start", 1)
	pD78 = loadspacehelper.CreateShip("D7", pVoltair2Set, "D7 8", "D7 8 Start", 1)
	pD79 = loadspacehelper.CreateShip("D7", pVoltair2Set, "D7 9", "D7 9 Start", 1)	
