...
def MissionHandler(pButton, pEvent):
	...
	dButtonToOverride = {
		...
		"Klingon Target of Opportunity":	["Episode", "M5"],
		"Romulan Target of Opportunity":	["Episode", "M6"],
		"Cardassian Target of Opportunity":	["Episode", "M7"],
		"Klingon Overrun Defense":		["Episode", "M8"],
		"Romulan Overrun Defense":		["Episode", "M9"],
		"Cardassian Overrun Defense":		["Episode", "M10"],
