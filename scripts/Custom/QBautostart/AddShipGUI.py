			...
			if verbose:
                ...
                # add to the submenu
                        ...
                        while(len(SubMenu) > 0 and type(SubMenu) == type([])):
                                if not dict_sides.has_key(SubMenu[0]):
                                        dict_sides[SubMenu[0]] = App.STCharacterMenu_Create(SubMenu[0])
                                        dict_sides[LastSubMenu].AddChild(dict_sides[SubMenu[0]], 0, 0, 0)
                                # the rest list
