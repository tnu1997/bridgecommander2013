...
class GUICreator:
	...
	def CreateMessageBox(self, name, text):
		...
		pMessageBox.Run(App.TGString(name), App.TGString(text), App.TGString("OK"), None, None, None)
...
def GetWindow(sName, ObjType = "Stylized Window"):
	...
	while TCWChild:
		...
		elif ObjType == "Character Menu":
			TCWWindow = App.STCharacterMenu_Cast(TCWChild)
		if TCWWindow:
