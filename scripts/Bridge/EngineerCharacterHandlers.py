...
def SubsystemDisabled(pObject, pEvent):
	...
	if not (pPlayer):
		pObject.CallNextHandler(pEvent)
		debug(__name__ + ", SubsystemDisabled Return")
		return
...
#	debug("A system has become disabled")
	...
	debug(__name__ + ", SubsystemDisabled End")
	pObject.CallNextHandler(pEvent)
...
def SubsystemDestroyed(pObject, pEvent):
	...
	if not (pPlayer):
		pObject.CallNextHandler(pEvent)
		debug(__name__ + ", SubsystemDestroyed Return")
		return
	...
	debug(__name__ + ", SubsystemDestroyed End")
	pObject.CallNextHandler(pEvent)
